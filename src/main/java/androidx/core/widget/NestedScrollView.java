...
public class NestedScrollView extends FrameLayout implements l, p {
    ...
    private OverScroller f1888c;

    /* renamed from: d  reason: collision with root package name */
    private EdgeEffect f1889d;

    /* renamed from: e  reason: collision with root package name */
    private EdgeEffect f1890e;
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet, int i2) {
        ...
        w.a((View) this, (androidx.core.g.a) w);
    }
    ...
    private void a() {
        this.f1888c = new OverScroller(getContext());
        setFocusable(true);
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i2 != 0) {
                ...
                if (i2 == 2) {
                    ...
                    if (i3 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            ...
                            if (Math.abs(y2 - this.f1891f) > this.n && (2 & getNestedScrollAxes()) == 0) {
                                this.j = true;
                                this.f1891f = y2;
                                d();
            ...
            this.q = -1;
            e();
            if (this.f1888c.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                w.e(this);
            }
            a(0);
        } else {
            ...
            if (!d((int) motionEvent.getX(), y3)) {
                ...
                c();
                this.k.addMovement(motionEvent);
                this.f1888c.computeScrollOffset();
                this.j = !this.f1888c.isFinished();
                a(2, 0);
            }
        }
        return this.j;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                } else if (this.f1888c.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    w.e(this);
                }
                this.q = -1;
                g();
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.j) {
                        ...
                        if (z2) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                d.a(this.f1889d, ((float) i7) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.f1890e.isFinished()) {
                                    this.f1890e.onRelease();
                                }
                            } else if (i8 > i5) {
                                d.a(this.f1890e, ((float) i7) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                if (!this.f1889d.isFinished()) {
                                    this.f1889d.onRelease();
                                }
                            }
                            EdgeEffect edgeEffect = this.f1889d;
                            if (edgeEffect != null && (!edgeEffect.isFinished() || !this.f1890e.isFinished())) {
                                w.e(this);
                            }
                        }
                    }
                ...
                if (this.j && getChildCount() > 0 && this.f1888c.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    w.e(this);
                }
                this.q = -1;
                g();
                ...
                this.f1891f = (int) motionEvent2.getY(actionIndex);
                this.q = motionEvent2.getPointerId(actionIndex);
            } else if (actionMasked == 6) {
                a(motionEvent);
                this.f1891f = (int) motionEvent2.getY(motionEvent2.findPointerIndex(this.q));
            }
        } else if (getChildCount() == 0) {
            return false;
        } else {
            boolean z3 = !this.f1888c.isFinished();
            this.j = z3;
            if (z3) {
            ...
            if (!this.f1888c.isFinished()) {
                f();
            }
            this.f1891f = (int) motionEvent.getY();
    ...
    private void a(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.q) {
            ...
            this.f1891f = (int) motionEvent.getY(i2);
    ...
    public boolean a(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x005f:
            ...
            android.widget.OverScroller r3 = r0.f1888c
            r8 = 0
            r9 = 0
            r10 = 0
    ...
    public boolean c(int i2) {
        ...
        if (z2) {
            this.f1887b.top = getScrollY() + height;
            int childCount = getChildCount();
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
                int bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
                if (this.f1887b.top + height > bottom) {
                    this.f1887b.top = bottom - height;
                }
            }
        } else {
            this.f1887b.top = getScrollY() - height;
            if (this.f1887b.top < 0) {
                this.f1887b.top = 0;
            }
        }
        Rect rect = this.f1887b;
        rect.bottom = rect.top + height;
        return a(i2, this.f1887b.top, this.f1887b.bottom);
    }
    ...
    public boolean d(int i2) {
        ...
        if (z2) {
            ...
            if (childCount > 0) {
                View childAt = getChildAt(childCount - 1);
                this.f1887b.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
    ...
    public boolean e(int i2) {
        ...
        if (findNextFocus == null || !a(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f1887b);
            offsetDescendantRectToMyCoords(findNextFocus, this.f1887b);
            g(a(this.f1887b));
    ...
    private boolean a(View view, int i2, int i3) {
        view.getDrawingRect(this.f1887b);
        offsetDescendantRectToMyCoords(view, this.f1887b);
        return this.f1887b.bottom + i2 >= getScrollY() && this.f1887b.top - i2 <= getScrollY() + i3;
    }
    ...
    public final void b(int i2, int i3) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.f1886a > 250) {
                View childAt = getChildAt(0);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
                int height = childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin;
                int height2 = (getHeight() - getPaddingTop()) - getPaddingBottom();
                int scrollY = getScrollY();
                OverScroller overScroller = this.f1888c;
            ...
            this.f1886a = AnimationUtils.currentAnimationTimeMillis();
        }
    }
    ...
    public void computeScroll() {
        if (!this.f1888c.isFinished()) {
            this.f1888c.computeScrollOffset();
            int currY = this.f1888c.getCurrY();
            int i2 = currY - this.u;
            this.u = currY;
            int[] iArr = this.s;
            boolean z2 = false;
            ...
            if (i3 != 0) {
                ...
                if (z2) {
                    ...
                    if (i3 < 0) {
                        if (this.f1889d.isFinished()) {
                            this.f1889d.onAbsorb((int) this.f1888c.getCurrVelocity());
                        }
                    } else if (this.f1890e.isFinished()) {
                        this.f1890e.onAbsorb((int) this.f1888c.getCurrVelocity());
                    }
                }
                f();
            }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (!this.h) {
            if (this.v != null) {
                scrollTo(getScrollX(), this.v.f1893a);
                this.v = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    public void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        if (findFocus != null && this != findFocus && a(findFocus, 0, i5)) {
            findFocus.getDrawingRect(this.f1887b);
            offsetDescendantRectToMyCoords(findFocus, this.f1887b);
            g(a(this.f1887b));
        }
    }
    ...
    public void f(int i2) {
        if (getChildCount() > 0) {
            this.f1888c.fling(getScrollX(), getScrollY(), 0, i2, 0, 0, RNCartPanelDataEntity.NULL_VALUE, Integer.MAX_VALUE, 0, 0);
            a(true);
        }
    }
    ...
    private void h() {
        if (getOverScrollMode() == 2) {
            this.f1889d = null;
            this.f1890e = null;
        } else if (this.f1889d == null) {
            Context context = getContext();
            this.f1889d = new EdgeEffect(context);
            this.f1890e = new EdgeEffect(context);
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f1889d != null) {
            ...
            if (!this.f1889d.isFinished()) {
                ...
                this.f1889d.setSize(width, height);
                if (this.f1889d.draw(canvas)) {
                    w.e(this);
                }
            ...
            if (!this.f1890e.isFinished()) {
                ...
                this.f1890e.setSize(width2, height2);
                if (this.f1890e.draw(canvas)) {
                    w.e(this);
                }
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f1893a + "}";
        }
    }
