...
public class j {
    ...
    private static java.nio.ByteBuffer a(java.io.File r9) {
        ...
        L_0x002d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.j.a(java.io.File):java.nio.ByteBuffer");
    }
    ...
    public static java.nio.ByteBuffer a(android.content.Context r8, android.os.CancellationSignal r9, android.net.Uri r10) {
        ...
        L_0x005d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.j.a(android.content.Context, android.os.CancellationSignal, android.net.Uri):java.nio.ByteBuffer");
    }
