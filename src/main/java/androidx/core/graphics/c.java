...
public class c {
    ...
    public static boolean a(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f1824a != bVarArr2[i].f1824a || bVarArr[i].f1825b.length != bVarArr2[i].f1825b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void b(b[] bVarArr, b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f1824a = bVarArr2[i].f1824a;
            for (int i2 = 0; i2 < bVarArr2[i].f1825b.length; i2++) {
                bVarArr[i].f1825b[i2] = bVarArr2[i].f1825b[i2];
            }
        }
    }
    ...
    public static class b {
        ...
        b(b bVar) {
            this.f1824a = bVar.f1824a;
            float[] fArr = bVar.f1825b;
            this.f1825b = c.a(fArr, 0, fArr.length);
        }
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            char c2 = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c2, bVarArr[i].f1824a, bVarArr[i].f1825b);
                c2 = bVarArr[i].f1824a;
            }
        }
        ...
        public void a(b bVar, b bVar2, float f2) {
            ...
            while (true) {
                float[] fArr = bVar.f1825b;
                if (i < fArr.length) {
                    this.f1825b[i] = (fArr[i] * (1.0f - f2)) + (bVar2.f1825b[i] * f2);
                    i++;
                } else {
                    return;
                }
        ...
        private static void a(Path path, float[] fArr, char c2, char c3, float[] fArr2) {
            ...
            while (i3 < fArr3.length) {
                if (c4 != 'A') {
                    if (c4 == 'C') {
                        ...
                        if (c4 == 'c') {
                            ...
                            if (c4 != 'q') {
                                if (c4 == 'v') {
                                    int i18 = i3 + 0;
                                    path2.rLineTo(BitmapDescriptorFactory.HUE_RED, fArr3[i18]);
                                    f7 = fArr3[i18];
                                } else if (c4 != 'L') {
                                    if (c4 == 'M') {
                                        int i19 = i3 + 0;
                            ...
                            int i43 = i3 + 0;
                            path2.rLineTo(fArr3[i43], BitmapDescriptorFactory.HUE_RED);
                            f18 += fArr3[i43];
                        }
                        i2 = i3;
                    } else {
                        ...
                        float f37 = f19;
                        i2 = i3;
                        a(path, f18, f19, f33, f34, f35, f36, fArr3[i3 + 2], fArr3[i3 + 3] != BitmapDescriptorFactory.HUE_RED, fArr3[i3 + 4] != BitmapDescriptorFactory.HUE_RED);
                        f2 = f18 + fArr3[i44];
                        f3 = f37 + fArr3[i45];
                    }
                    i3 = i2 + i;
                    ...
                    int i46 = i2 + 5;
                    int i47 = i2 + 6;
                    a(path, f18, f19, fArr3[i46], fArr3[i47], fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != BitmapDescriptorFactory.HUE_RED, fArr3[i2 + 4] != BitmapDescriptorFactory.HUE_RED);
                    f2 = fArr3[i46];
                    f3 = fArr3[i47];
                }
                f15 = f19;
