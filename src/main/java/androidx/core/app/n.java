...
public abstract class n {
    ...
    public Parcelable a(View view, Matrix matrix, RectF rectF) {
        ...
        if (this.f1623a == null) {
            this.f1623a = new Matrix();
        }
        this.f1623a.set(matrix);
        this.f1623a.postTranslate(-rectF.left, -rectF.top);
        this.f1623a.postScale(min, min);
        Bitmap createBitmap = Bitmap.createBitmap(i, i2, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(createBitmap);
        canvas.concat(this.f1623a);
        view.draw(canvas);
        return createBitmap;
    }
