...
public class ConstraintLayout extends ViewGroup {
    ...
    SparseArray<View> f1452a = new SparseArray<>();
    ...
    private ArrayList<b> f1458g = new ArrayList<>(4);
        ...
        if (attributeSet != null) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == f.b.ConstraintLayout_Layout_android_minWidth) {
                    ...
                    try {
                        this.o = new c();
                        this.o.b(getContext(), resourceId);
    ...
    private void c() {
        ...
        for (int i8 = 0; i8 < childCount; i8++) {
            androidx.constraintlayout.a.a.f a2 = a(getChildAt(i8));
            if (a2 != null) {
                a2.g();
            }
        }
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (a3 != null) {
                ...
                if (aVar.Y) {
                ...
                } else if (aVar.f1462d != -1 || aVar.f1463e != -1 || aVar.f1464f != -1 || aVar.f1465g != -1 || aVar.q != -1 || aVar.p != -1 || aVar.r != -1 || aVar.s != -1 || aVar.h != -1 || aVar.i != -1 || aVar.j != -1 || aVar.k != -1 || aVar.l != -1 || aVar.Q != -1 || aVar.R != -1 || aVar.m != -1 || aVar.width == -1 || aVar.height == -1) {
                    int i15 = aVar.ab;
                    int i16 = aVar.ac;
                    int i17 = aVar.ad;
                    int i18 = aVar.ae;
                    ...
                    int i27 = i17;
                    if (aVar.m != -1) {
                        androidx.constraintlayout.a.a.f b2 = b(aVar.m);
                        if (b2 != null) {
                            a3.a(b2, aVar.o, aVar.n);
                        }
                    } else {
                        if (i15 != -1) {
                            androidx.constraintlayout.a.a.f b3 = b(i15);
                            if (b3 != null) {
                                e.c cVar2 = e.c.LEFT;
                                f2 = f5;
                                e.c cVar3 = e.c.LEFT;
                                i6 = i26;
                                a3.a(cVar2, b3, cVar3, aVar.leftMargin, i3);
                            } else {
                                f2 = f5;
                                i6 = i26;
                            }
                            ...
                            i5 = i26;
                            if (i4 != -1) {
                                androidx.constraintlayout.a.a.f b4 = b(i4);
                                if (b4 != null) {
                                    a3.a(e.c.LEFT, b4, e.c.RIGHT, aVar.leftMargin, i3);
                                }
                            }
                        }
                        if (i27 != -1) {
                            androidx.constraintlayout.a.a.f b5 = b(i27);
                            if (b5 != null) {
                                a3.a(e.c.RIGHT, b5, e.c.LEFT, aVar.rightMargin, i2);
                            }
                        } else if (i5 != -1) {
                            androidx.constraintlayout.a.a.f b6 = b(i5);
                            if (b6 != null) {
                                a3.a(e.c.RIGHT, b6, e.c.RIGHT, aVar.rightMargin, i2);
                            }
                        }
                        if (aVar.h != -1) {
                            androidx.constraintlayout.a.a.f b7 = b(aVar.h);
                            if (b7 != null) {
                                a3.a(e.c.TOP, b7, e.c.TOP, aVar.topMargin, aVar.u);
                            }
                        } else if (aVar.i != -1) {
                            androidx.constraintlayout.a.a.f b8 = b(aVar.i);
                            if (b8 != null) {
                                a3.a(e.c.TOP, b8, e.c.BOTTOM, aVar.topMargin, aVar.u);
                            }
                        }
                        if (aVar.j != -1) {
                            androidx.constraintlayout.a.a.f b9 = b(aVar.j);
                            if (b9 != null) {
                                a3.a(e.c.BOTTOM, b9, e.c.TOP, aVar.bottomMargin, aVar.w);
                            }
                        } else if (aVar.k != -1) {
                            androidx.constraintlayout.a.a.f b10 = b(aVar.k);
                            if (b10 != null) {
                                a3.a(e.c.BOTTOM, b10, e.c.BOTTOM, aVar.bottomMargin, aVar.w);
                            }
                        }
                        if (aVar.l != -1) {
                            View view = this.f1452a.get(aVar.l);
                        ...
                        if (aVar.A >= BitmapDescriptorFactory.HUE_RED && aVar.A != 0.5f) {
                            a3.b(aVar.A);
                        }
                    }
                    ...
                    if (aVar.V) {
                        ...
                        a3.a(e.c.LEFT).f1380d = aVar.leftMargin;
                        a3.a(e.c.RIGHT).f1380d = aVar.rightMargin;
                    } else {
                    ...
                    if (aVar.W) {
                        ...
                        a3.a(e.c.TOP).f1380d = aVar.topMargin;
                        a3.a(e.c.BOTTOM).f1380d = aVar.bottomMargin;
                        z = false;
                    } else {
    ...
    private final androidx.constraintlayout.a.a.f b(int i2) {
        if (i2 == 0) {
            return this.f1453b;
        }
        View view = this.f1452a.get(i2);
        if (view == null) {
    ...
    private void b(int r24, int r25) {
        ...
        L_0x00af:
            ...
            boolean r6 = r10.W
            if (r6 == 0) goto L_0x00d7
            androidx.constraintlayout.a.a.n r6 = r15.j()
            r6.a(r2)
            androidx.constraintlayout.a.a.n r2 = r15.k()
            r2.a(r3)
            goto L_0x00d7
        L_0x00c6:
            r12 = r3
        ...
        L_0x00de:
            r12 = r3
            androidx.constraintlayout.a.a.g r2 = r0.f1453b
            r2.P()
            r2 = 0
        L_0x00e5:
        ...
        L_0x0199:
            androidx.constraintlayout.a.a.g r2 = r0.f1453b
            androidx.constraintlayout.a.a.f$a r2 = r2.H()
        ...
        L_0x01af:
            ...
            androidx.constraintlayout.a.a.n r2 = r7.k()
            r2.e()
        L_0x01b8:
        ...
        L_0x0204:
            ...
            float r5 = r5 - r8
            int r13 = (int) r5
            androidx.constraintlayout.a.a.n r5 = r7.k()
            r5.a(r13)
            r5 = r25
    ...
    public void onMeasure(int r25, int r26) {
        /*
            ...
            androidx.constraintlayout.a.a.g r9 = r0.f1453b
            r9.h(r7)
            androidx.constraintlayout.a.a.g r9 = r0.f1453b
            r9.i(r8)
            androidx.constraintlayout.a.a.g r9 = r0.f1453b
        ...
        L_0x004f:
            ...
            androidx.constraintlayout.a.a.g r9 = r0.f1453b
            int r9 = r9.q()
            androidx.constraintlayout.a.a.g r12 = r0.f1453b
            int r12 = r12.s()
            boolean r13 = r0.m
        ...
        L_0x0074:
            ...
            androidx.constraintlayout.a.a.g r15 = r0.f1453b
            r15.O()
            androidx.constraintlayout.a.a.g r15 = r0.f1453b
            r15.f(r9, r12)
            r24.b(r25, r26)
        ...
        L_0x0087:
            ...
            androidx.constraintlayout.a.a.g r13 = r0.f1453b
        ...
        L_0x0097:
            ...
            r13.j(r11)
        L_0x00b4:
            androidx.constraintlayout.a.a.g r11 = r0.f1453b
        ...
        L_0x00d7:
            ...
            androidx.constraintlayout.a.a.g r3 = r0.f1453b
        ...
        L_0x013f:
            ...
            androidx.constraintlayout.a.a.g r6 = r0.f1453b
            androidx.constraintlayout.a.a.f$a r6 = r6.G()
        ...
        L_0x015e:
            androidx.constraintlayout.a.a.g r11 = r0.f1453b
            androidx.constraintlayout.a.a.f$a r11 = r11.H()
        ...
        L_0x01cb:
            ...
            androidx.constraintlayout.a.a.n r9 = r15.k()
            boolean r9 = r9.g()
            if (r9 == 0) goto L_0x01e2
            goto L_0x01c9
        L_0x01e2:
        ...
        L_0x0223:
            ...
            androidx.constraintlayout.a.a.n r10 = r15.j()
            r10.a(r1)
        L_0x023d:
        ...
        L_0x025a:
            ...
            androidx.constraintlayout.a.a.n r1 = r15.k()
            r1.a(r9)
        L_0x026c:
        ...
        L_0x02ca:
            ...
            androidx.constraintlayout.a.a.g r1 = r0.f1453b
            r4 = r20
            r1.j(r4)
            androidx.constraintlayout.a.a.g r1 = r0.f1453b
            r4 = r22
        ...
        L_0x0372:
            ...
            int r1 = r1.q()
            int r1 = r1 + r7
            androidx.constraintlayout.a.a.g r4 = r0.f1453b
            int r4 = r4.s()
            int r4 = r4 + r8
    ...
    private void c(int i2, int i3) {
        ...
        this.f1453b.b(aVar2);
        this.f1453b.k(size2);
        this.f1453b.l((this.i - getPaddingLeft()) - getPaddingRight());
        this.f1453b.m((this.j - getPaddingTop()) - getPaddingBottom());
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if ((childAt.getVisibility() != 8 || aVar.Y || aVar.Z || isInEditMode) && !aVar.aa) {
                ...
                int q2 = fVar.q() + u;
                int s2 = fVar.s() + v;
                childAt.layout(u, v, q2, s2);
                if (childAt instanceof e) {
                    View content = ((e) childAt).getContent();
                    if (content != null) {
                        content.setVisibility(0);
                        content.layout(u, v, q2, s2);
                    }
                }
            }
        }
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        int aj;
        float ak;
        androidx.constraintlayout.a.a.f al = new androidx.constraintlayout.a.a.f();
        ...
        private static class C0026a {
            ...
            /* renamed from: a  reason: collision with root package name */
            public static final SparseIntArray f1466a = new SparseIntArray();

            static {
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintLeft_toLeftOf, 8);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintLeft_toRightOf, 9);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintRight_toLeftOf, 10);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintRight_toRightOf, 11);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintTop_toTopOf, 12);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintTop_toBottomOf, 13);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintBottom_toTopOf, 14);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintBottom_toBottomOf, 15);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintBaseline_toBaselineOf, 16);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintCircle, 2);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintCircleRadius, 3);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintCircleAngle, 4);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_editor_absoluteX, 49);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_editor_absoluteY, 50);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintGuide_begin, 5);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintGuide_end, 6);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintGuide_percent, 7);
                f1466a.append(f.b.ConstraintLayout_Layout_android_orientation, 1);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintStart_toEndOf, 17);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintStart_toStartOf, 18);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintEnd_toStartOf, 19);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintEnd_toEndOf, 20);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginLeft, 21);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginTop, 22);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginRight, 23);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginBottom, 24);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginStart, 25);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_goneMarginEnd, 26);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHorizontal_bias, 29);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintVertical_bias, 30);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintDimensionRatio, 44);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHorizontal_weight, 45);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintVertical_weight, 46);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHorizontal_chainStyle, 47);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintVertical_chainStyle, 48);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constrainedWidth, 27);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constrainedHeight, 28);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintWidth_default, 31);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHeight_default, 32);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintWidth_min, 33);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintWidth_max, 34);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintWidth_percent, 35);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHeight_min, 36);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHeight_max, 37);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintHeight_percent, 38);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintLeft_creator, 39);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintTop_creator, 40);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintRight_creator, 41);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintBottom_creator, 42);
                f1466a.append(f.b.ConstraintLayout_Layout_layout_constraintBaseline_creator, 43);
            }
        }
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (C0026a.f1466a.get(index)) {
                    case 1:
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        this.f1460b = obtainStyledAttributes.getDimensionPixelOffset(index, this.f1460b);
                        break;
                    case 7:
                        this.f1461c = obtainStyledAttributes.getFloat(index, this.f1461c);
                        break;
                    case 8:
                        ...
                        if (this.f1462d != -1) {
                            ...
                            this.f1462d = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 9:
                        ...
                        if (this.f1463e != -1) {
                            ...
                            this.f1463e = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 10:
                        this.f1464f = obtainStyledAttributes.getResourceId(index, this.f1464f);
                        if (this.f1464f != -1) {
                            break;
                        } else {
                            this.f1464f = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 11:
                        this.f1465g = obtainStyledAttributes.getResourceId(index, this.f1465g);
                        if (this.f1465g != -1) {
                            break;
                        } else {
                            this.f1465g = obtainStyledAttributes.getInt(index, -1);
                            break;
                        }
                    case 12:
                    ...
                    case 38:
                        this.P = Math.max(BitmapDescriptorFactory.HUE_RED, obtainStyledAttributes.getFloat(index, this.P));
                        break;
                    case 44:
        ...
        public void a() {
            ...
            if (this.f1461c != -1.0f || this.f1459a != -1 || this.f1460b != -1) {
                this.Y = true;
                this.V = true;
                this.W = true;
