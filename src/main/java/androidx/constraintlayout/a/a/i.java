...
public class i extends f {
    ...
    public void b(int i) {
        ...
        if (l != null) {
            if (b() == 1) {
                this.t.a().a(1, l.t.a(), 0);
                this.v.a().a(1, l.t.a(), 0);
                if (this.aj != -1) {
                    this.s.a().a(1, l.s.a(), this.aj);
                    this.u.a().a(1, l.s.a(), this.aj);
                } else if (this.ak != -1) {
                    this.s.a().a(1, l.u.a(), -this.ak);
                    this.u.a().a(1, l.u.a(), -this.ak);
                } else if (this.ai != -1.0f && l.G() == f.a.FIXED) {
                    int i2 = (int) (((float) l.E) * this.ai);
                    this.s.a().a(1, l.s.a(), i2);
                    this.u.a().a(1, l.s.a(), i2);
                }
            } else {
                this.s.a().a(1, l.s.a(), 0);
                this.u.a().a(1, l.s.a(), 0);
                if (this.aj != -1) {
                    this.t.a().a(1, l.t.a(), this.aj);
                    this.v.a().a(1, l.t.a(), this.aj);
                } else if (this.ak != -1) {
                    this.t.a().a(1, l.v.a(), -this.ak);
                    this.v.a().a(1, l.v.a(), -this.ak);
                } else if (this.ai != -1.0f && l.H() == f.a.FIXED) {
                    int i3 = (int) (((float) l.F) * this.ai);
                    this.t.a().a(1, l.t.a(), i3);
                    this.v.a().a(1, l.t.a(), i3);
                }
            }
        }
    }
