...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, h, t, androidx.savedstate.c {
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel, ClassLoader classLoader) {
            this.f2130a = parcel.readBundle();
            if (classLoader != null) {
                Bundle bundle = this.f2130a;
                if (bundle != null) {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            parcel.writeBundle(this.f2130a);
        }
    }
    ...
    public void setInitialSavedState(SavedState savedState) {
        if (this.mFragmentManager == null) {
            this.mSavedFragmentState = (savedState == null || savedState.f2130a == null) ? null : savedState.f2130a;
            return;
        }
    ...
    public final Fragment getTargetFragment() {
        ...
        return iVar.f2181g.get(this.mTargetWho);
    }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (gVar != null) {
            ...
            androidx.core.g.f.a(b2, this.mChildFragmentManager.C());
            return b2;
        }
    ...
    public void setEnterTransition(Object obj) {
        ensureAnimationInfo().f2137g = obj;
    }
    ...
    public void startPostponedEnterTransition() {
        ...
        if (iVar == null || iVar.n == null) {
            ...
            this.mFragmentManager.n.j().postAtFrontOfQueue(new Runnable() {
                public void run() {
    ...
    public void performDetach() {
        ...
        } else if (!this.mChildFragmentManager.i()) {
            this.mChildFragmentManager.x();
            this.mChildFragmentManager = new i();
        }
    }
    ...
    public void setAnimatingAway(View view) {
        ensureAnimationInfo().f2131a = view;
    }

    /* access modifiers changed from: package-private */
    public void setAnimator(Animator animator) {
        ensureAnimationInfo().f2132b = animator;
    }
