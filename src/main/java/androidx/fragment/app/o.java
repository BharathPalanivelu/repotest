...
public abstract class o {
    ...
    public void a(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        s.a(view, new Runnable() {
            public void run() {
                for (int i = 0; i < size; i++) {
                    w.a((View) arrayList5.get(i), (String) arrayList6.get(i));
                    w.a((View) arrayList7.get(i), (String) arrayList4.get(i));
                }
            }
        });
    }
        ...
        s.a(view, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    String q = w.q(view);
                    if (q != null) {
                        w.a(view, o.a((Map<String, String>) map, q));
                    }
                }
            }
        });
    ...
    public void a(ViewGroup viewGroup, final ArrayList<View> arrayList, final Map<String, String> map) {
        s.a(viewGroup, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    View view = (View) arrayList.get(i);
                    w.a(view, (String) map.get(w.q(view)));
                }
            }
        });
    }
