...
class al extends c implements View.OnClickListener {
    private final SearchManager j = ((SearchManager) this.f1330d.getSystemService("search"));
    ...
    private static final class a {
        ...
        public a(View view) {
            this.f1128a = (TextView) view.findViewById(16908308);
            this.f1129b = (TextView) view.findViewById(16908309);
            this.f1130c = (ImageView) view.findViewById(16908295);
            this.f1131d = (ImageView) view.findViewById(16908296);
            this.f1132e = (ImageView) view.findViewById(a.f.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f1128a != null) {
            a(aVar.f1128a, (CharSequence) a(cursor, this.s));
        }
        if (aVar.f1129b != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                if (aVar.f1128a != null) {
                    aVar.f1128a.setSingleLine(false);
                    aVar.f1128a.setMaxLines(2);
                }
            } else if (aVar.f1128a != null) {
                aVar.f1128a.setSingleLine(true);
                aVar.f1128a.setMaxLines(1);
            }
            a(aVar.f1129b, charSequence);
        }
        if (aVar.f1130c != null) {
            a(aVar.f1130c, e(cursor), 4);
        }
        if (aVar.f1131d != null) {
            a(aVar.f1131d, f(cursor), 8);
        }
        int i3 = this.q;
        if (i3 == 2 || (i3 == 1 && (i2 & 1) != 0)) {
            aVar.f1132e.setVisibility(0);
            aVar.f1132e.setTag(aVar.f1128a.getText());
            aVar.f1132e.setOnClickListener(this);
            return;
        }
        aVar.f1132e.setVisibility(8);
    }
    ...
    private CharSequence b(CharSequence charSequence) {
        if (this.r == null) {
            ...
            this.f1330d.getTheme().resolveAttribute(a.C0012a.textColorSearchUrl, typedValue, true);
            this.r = this.f1330d.getResources().getColorStateList(typedValue.resourceId);
        }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View a2 = a(this.f1330d, this.f1329c, viewGroup);
            if (a2 != null) {
                ((a) a2.getTag()).f1128a.setText(e2.toString());
            }
            return a2;
        }
    }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e2);
            View b2 = b(this.f1330d, this.f1329c, viewGroup);
            if (b2 != null) {
                ((a) b2.getTag()).f1128a.setText(e2.toString());
            }
            return b2;
        }
    }
    ...
    private Drawable g(Cursor cursor) {
        ...
        return this.f1330d.getPackageManager().getDefaultActivityIcon();
    }
    ...
    private Drawable b(ComponentName componentName) {
        PackageManager packageManager = this.f1330d.getPackageManager();
        try {
    ...
    public Drawable a(Uri uri) throws FileNotFoundException {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f1330d.getPackageManager().getResourcesForApplication(authority);
    ...
    public Cursor a(SearchableInfo searchableInfo, String str, int i) {
        ...
        return this.f1330d.getContentResolver().query(fragment.build(), (String[]) null, suggestSelection, strArr2, (String) null);
    }
}
