...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f982a = obtainStyledAttributes.getBoolean(a.j.ButtonBarLayout_allowStacking, true);
    ...
    public void setAllowStacking(boolean z) {
        if (this.f982a != z) {
            this.f982a = z;
            if (!this.f982a && getOrientation() == 1) {
                setStacked(false);
            }
            requestLayout();
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (a() || View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            i3 = View.MeasureSpec.makeMeasureSpec(size, RNCartPanelDataEntity.NULL_VALUE);
            z = true;
        }
    ...
    public int getMinimumHeight() {
        return Math.max(this.f984c, super.getMinimumHeight());
    }
