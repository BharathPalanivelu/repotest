...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        int d7 = a2.d(a.j.Toolbar_contentInsetStart, RNCartPanelDataEntity.NULL_VALUE);
        int d8 = a2.d(a.j.Toolbar_contentInsetEnd, RNCartPanelDataEntity.NULL_VALUE);
        ...
        this.mContentInsetStartWithNavigation = a2.d(a.j.Toolbar_contentInsetStartWithNavigation, RNCartPanelDataEntity.NULL_VALUE);
        this.mContentInsetEndWithActions = a2.d(a.j.Toolbar_contentInsetEndWithActions, RNCartPanelDataEntity.NULL_VALUE);
    ...
    public void setMenu(g gVar, ActionMenuPresenter actionMenuPresenter) {
        if (gVar != null || this.mMenuView != null) {
            ensureMenuView();
            g d2 = this.mMenuView.d();
            if (d2 != gVar) {
                if (d2 != null) {
                    d2.b((m) this.mOuterActionMenuPresenter);
                    d2.b((m) this.mExpandedMenuPresenter);
                }
    ...
    public boolean hasExpandedActionView() {
        ...
        return (aVar == null || aVar.f1032b == null) ? false : true;
    }

    public void collapseActionView() {
        a aVar = this.mExpandedMenuPresenter;
        i iVar = aVar == null ? null : aVar.f1032b;
        if (iVar != null) {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.f632a = 8388613 | (this.mButtonGravity & 112);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, a.C0012a.toolbarNavigationButtonStyle);
            b generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.f632a = 8388611 | (this.mButtonGravity & 112);
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, a.C0012a.toolbarNavigationButtonStyle);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        a aVar = this.mExpandedMenuPresenter;
        if (!(aVar == null || aVar.f1032b == null)) {
            savedState.f1029a = this.mExpandedMenuPresenter.f1032b.getItemId();
        }
        savedState.f1030b = isOverflowMenuShowing();
        return savedState;
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (!(savedState.f1029a == 0 || this.mExpandedMenuPresenter == null || d2 == null)) {
            MenuItem findItem = d2.findItem(savedState.f1029a);
            if (findItem != null) {
                findItem.expandActionView();
            }
        }
        if (savedState.f1030b) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (((b) childAt.getLayoutParams()).f1034b == 0 && shouldLayout(childAt)) {
    ...
    public void onLayout(boolean r19, int r20, int r21, int r22, int r23) {
        /*
            r18 = this;
            r0 = r18
            int r1 = androidx.core.g.w.g(r18)
            r2 = 1
            r3 = 0
        ...
        L_0x000d:
            ...
            r11[r2] = r3
            r11[r3] = r3
            int r12 = androidx.core.g.w.m(r18)
    ...
    private int getChildTop(View view, int i) {
        ...
        int childVerticalGravity = getChildVerticalGravity(bVar.f632a);
    ...
    private void addCustomViewsWithGravity(List<View> list, int i) {
        ...
        int childCount = getChildCount();
        int a2 = d.a(i, w.g(this));
        list.clear();
        if (z) {
            for (int i2 = childCount - 1; i2 >= 0; i2--) {
                View childAt = getChildAt(i2);
                b bVar = (b) childAt.getLayoutParams();
                if (bVar.f1034b == 0 && shouldLayout(childAt) && getChildHorizontalGravity(bVar.f632a) == a2) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (bVar2.f1034b == 0 && shouldLayout(childAt2) && getChildHorizontalGravity(bVar2.f632a) == a2) {
                list.add(childAt2);
            }
        }
    }
    ...
    private static boolean isCustomView(View view) {
        return ((b) view.getLayoutParams()).f1034b == 0;
    }

    public y getWrapper() {
        if (this.mWrapper == null) {
            this.mWrapper = new as(this, true);
        }
    ...
    public void removeChildrenForExpandedActionView() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (!(((b) childAt.getLayoutParams()).f1034b == 2 || childAt == this.mMenuView)) {
    ...
    public static class b extends a.C0015a {
        ...
        public b(b bVar) {
            super((a.C0015a) bVar);
            this.f1034b = bVar.f1034b;
        }

        public b(a.C0015a aVar) {
            super(aVar);
        }
    ...
    private class a implements m {
            ...
            if (this.f1032b != null) {
                ...
                if (gVar != null) {
                    ...
                    while (true) {
                        if (i >= size) {
                            break;
                        } else if (this.f1031a.getItem(i) == this.f1032b) {
                            z2 = true;
                            break;
                        } else {
                            i++;
        ...
        public boolean a(g gVar, i iVar) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.f632a = 8388611 | (Toolbar.this.mButtonGravity & 112);
                generateDefaultLayoutParams.f1034b = 2;
