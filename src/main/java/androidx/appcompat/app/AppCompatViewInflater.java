...
public class AppCompatViewInflater {
    ...
    /* access modifiers changed from: protected */
    public w createToggleButton(Context context, AttributeSet attributeSet) {
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || androidx.core.g.w.E(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(a.j.View_theme, 0);
            if (resourceId != 0) {
        ...
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof androidx.appcompat.view.d) || ((androidx.appcompat.view.d) context).a() != resourceId) ? new androidx.appcompat.view.d(context, resourceId) : context;
        }
        return context;
    }
    ...
    private static class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (this.f630c == null) {
                a(this.f628a.getContext(), this.f629b);
            }
            try {
                this.f630c.invoke(this.f631d, new Object[]{view});
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted()) {
                        Method method = context.getClass().getMethod(this.f629b, new Class[]{View.class});
                        if (method != null) {
                            this.f630c = method;
                            this.f631d = context;
                            return;
            ...
            int id = this.f628a.getId();
            if (id == -1) {
                str2 = "";
            } else {
                str2 = " with id '" + this.f628a.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f629b + "(View) in a parent or ancestor Context for android:onClick attribute defined on view " + this.f628a.getClass() + str2);
        }
    }
}
