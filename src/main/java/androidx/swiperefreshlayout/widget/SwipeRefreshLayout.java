...
public class SwipeRefreshLayout extends ViewGroup implements j, n {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f2, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.mProgress.b(1.0f - f2);
            }
        };
    ...
    private void createProgressView() {
        ...
        this.mProgress = new b(getContext());
        this.mProgress.a(1);
        this.mCircleView.setImageDrawable(this.mProgress);
        this.mCircleView.setVisibility(8);
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        AnonymousClass4 r0 = new Animation() {
            public void applyTransformation(float f2, Transformation transformation) {
                ...
                int i = i;
                bVar.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f2)));
            }
        };
        r0.setDuration(300);
        this.mCircleView.a((Animation.AnimationListener) null);
        this.mCircleView.clearAnimation();
    ...
    private void moveSpinner(float f2) {
        ...
        float f3 = (float) i;
        double max2 = (double) (Math.max(BitmapDescriptorFactory.HUE_RED, Math.min(abs, f3 * DECELERATE_INTERPOLATION_FACTOR) / f3) / 4.0f);
        double pow = Math.pow(max2, 2.0d);
        Double.isNaN(max2);
        float f4 = ((float) (max2 - pow)) * DECELERATE_INTERPOLATION_FACTOR;
        int i2 = this.mOriginalOffsetTop + ((int) ((f3 * min) + (f3 * f4 * DECELERATE_INTERPOLATION_FACTOR)));
        ...
        this.mProgress.a((float) BitmapDescriptorFactory.HUE_RED, Math.min(MAX_PROGRESS_ANGLE, max * MAX_PROGRESS_ANGLE));
        this.mProgress.b(Math.min(1.0f, max));
        this.mProgress.c((((max * 0.4f) - 16.0f) + (f4 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
    ...
    private void finishSpinner(float f2) {
        ...
        this.mRefreshing = false;
        this.mProgress.a((float) BitmapDescriptorFactory.HUE_RED, (float) BitmapDescriptorFactory.HUE_RED);
