...
public class a {
    ...
    public static a a(ViewGroup viewGroup, C0039a aVar) {
        return new a(viewGroup.getContext(), viewGroup, aVar);
    }

    public static a a(ViewGroup viewGroup, float f2, C0039a aVar) {
        a a2 = a(viewGroup, aVar);
        a2.f1929b = (int) (((float) a2.f1929b) * (1.0f / f2));
        return a2;
    }

    private a(Context context, ViewGroup viewGroup, C0039a aVar) {
        if (viewGroup == null) {
            ...
            this.f1929b = viewConfiguration.getScaledTouchSlop();
    ...
    public void a(View view, int i2) {
        ...
        throw new IllegalArgumentException("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (" + this.u + SQLBuilder.PARENTHESES_RIGHT);
    }
    ...
    public boolean a(View view, int i2, int i3) {
        ...
        if (!a2 && this.f1928a == 0 && this.s != null) {
            this.s = null;
        }
        return a2;
    }
    ...
    public boolean a(int i2, int i3) {
        if (this.t) {
            return a(i2, i3, (int) this.l.getXVelocity(this.f1930c), (int) this.l.getYVelocity(this.f1930c));
        }
    ...
    private int a(int i2, int i3, int i4) {
        ...
        return Math.min(i5, IjkMediaCodecInfo.RANK_LAST_CHANCE);
    }
    ...
    private void g() {
        float[] fArr = this.f1931d;
        if (fArr != null) {
            Arrays.fill(fArr, BitmapDescriptorFactory.HUE_RED);
            Arrays.fill(this.f1932e, BitmapDescriptorFactory.HUE_RED);
            Arrays.fill(this.f1933f, BitmapDescriptorFactory.HUE_RED);
            Arrays.fill(this.f1934g, BitmapDescriptorFactory.HUE_RED);
    ...
    private void f(int i2) {
        ...
        if (fArr == null || fArr.length <= i2) {
            ...
            float[] fArr6 = this.f1931d;
            if (fArr6 != null) {
                System.arraycopy(fArr6, 0, fArr2, 0, fArr6.length);
                float[] fArr7 = this.f1932e;
                System.arraycopy(fArr7, 0, fArr3, 0, fArr7.length);
                float[] fArr8 = this.f1933f;
                System.arraycopy(fArr8, 0, fArr4, 0, fArr8.length);
                float[] fArr9 = this.f1934g;
    ...
    private void c(MotionEvent motionEvent) {
        ...
        for (int i2 = 0; i2 < pointerCount; i2++) {
            ...
            if (g(pointerId)) {
                ...
                this.f1933f[pointerId] = x;
                this.f1934g[pointerId] = y;
            }
        }
    }
    ...
    public boolean a(android.view.MotionEvent r17) {
        ...
        L_0x003c:
            ...
            androidx.customview.a.a$a r4 = r0.r
            r1 = r1 & r3
            r4.a((int) r1, (int) r2)
            goto L_0x0031
        L_0x0060:
    ...
    public void b(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                ...
                if (this.f1928a == 1 && pointerId3 == this.f1930c) {
                    int pointerCount = motionEvent.getPointerCount();
                    while (true) {
                        if (i3 >= pointerCount) {
                            i2 = -1;
            ...
            while (i3 < pointerCount2) {
                ...
                if (g(pointerId5)) {
                    ...
                    float f2 = x3 - this.f1931d[pointerId5];
                    float f3 = y3 - this.f1932e[pointerId5];
                    b(f2, f3, pointerId5);
                    if (this.f1928a != 1) {
            ...
            c(motionEvent);
        } else if (g(this.f1930c)) {
            int findPointerIndex = motionEvent.findPointerIndex(this.f1930c);
            float x4 = motionEvent.getX(findPointerIndex);
            float y4 = motionEvent.getY(findPointerIndex);
            float[] fArr = this.f1933f;
            int i8 = this.f1930c;
            int i9 = (int) (x4 - fArr[i8]);
            int i10 = (int) (y4 - this.f1934g[i8]);
    ...
    private boolean a(float f2, float f3, int i2, int i3) {
        ...
        if (abs < abs2 * 0.5f && this.r.b(i3)) {
            ...
            iArr[i2] = iArr[i2] | i3;
            return false;
        } else if ((this.i[i2] & i3) != 0 || abs <= ((float) this.f1929b)) {
            return false;
        } else {
            return true;
        }
    ...
    private boolean a(View view, float f2, float f3) {
        ...
        if (z && z2) {
            ...
            if (Math.abs(f2) > ((float) this.f1929b)) {
                return true;
            }
            return false;
        } else if (!z2 || Math.abs(f3) <= ((float) this.f1929b)) {
            return false;
        } else {
            return true;
        }
    ...
    public boolean b(int i2, int i3) {
        ...
        boolean z = (i2 & 1) == 1;
        boolean z2 = (i2 & 2) == 2;
        float f2 = this.f1933f[i3] - this.f1931d[i3];
        float f3 = this.f1934g[i3] - this.f1932e[i3];
        if (z && z2) {
            int i4 = this.f1929b;
    ...
    private void h() {
        ...
        a(a(this.l.getXVelocity(this.f1930c), this.n, this.m), a(this.l.getYVelocity(this.f1930c), this.n, this.m));
    }
