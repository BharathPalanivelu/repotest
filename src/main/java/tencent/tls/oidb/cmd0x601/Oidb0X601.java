...
public final class Oidb0X601 {
    ...
    public static final class OpenAccountInfo extends MessageMicro<OpenAccountInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_openacctype", "str_openappid", "str_openid"}, new Object[]{0, "", ""}, OpenAccountInfo.class);
    ...
    public static final class OpenSigInfo extends MessageMicro<OpenSigInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_opensigtype", "str_openappid", "bytes_opensig"}, new Object[]{0, "", ByteStringMicro.EMPTY}, OpenSigInfo.class);
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 32, 40}, new String[]{"openaccount", "useraccount", "opensig", "uint32_sdkappid", "uint64_tinyid"}, new Object[]{null, null, null, 0, 0L}, ReqBody.class);
    ...
    public static final class UserAccountInfo extends MessageMicro<UserAccountInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"uint32_useracctype", "str_useraccount", "str_usersig"}, new Object[]{0, "", ""}, UserAccountInfo.class);
