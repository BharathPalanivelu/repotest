...
public final class Oidb0X483 {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"uint32_appid", "uint32_account_type", "str_code"}, new Object[]{0, 0, ""}, ReqBody.class);
    ...
    public static final class TokenInfo extends MessageMicro<TokenInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 34, 42, 50}, new String[]{"str_access_token", "uint32_expires_in", "str_refresh_token", "str_openid", "str_scope", "str_unionid"}, new Object[]{"", 0, "", "", "", ""}, TokenInfo.class);
