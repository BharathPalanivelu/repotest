...
public final class Oidb0X602 {
    ...
    public static final class Open2UserInfo extends MessageMicro<Open2UserInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 50, 56}, new String[]{"uint32_openacctype", "str_openappid", "str_openid", "uint32_useracctype", "uint32_sdkappid", "str_userid", "uint32_result_flg"}, new Object[]{0, "", "", 0, 0, "", 0}, Open2UserInfo.class);
    ...
    public static final class OpenAccountInfo extends MessageMicro<OpenAccountInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 42}, new String[]{"uint32_openacctype", "str_openappid", "str_openid", "uint32_sdkappid", "str_access_token"}, new Object[]{0, "", "", 0, ""}, OpenAccountInfo.class);
