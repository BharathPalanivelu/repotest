    ...
    public boolean setupFillPaint(Paint paint, float f2) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                ...
                float f3 = fArr3[1] * this.mScale;
                float f4 = this.mBrushData[2] * this.mScale;
                float f5 = this.mBrushData[3] * this.mScale;
                float f6 = this.mBrushData[4] * this.mScale;
                ...
                paint2.setShader(new LinearGradient(f3, f4, f5, f6, iArr, fArr, Shader.TileMode.CLAMP));
            }
            return true;
        }
        float f7 = fArr3.length > 4 ? fArr3[4] * f2 * 255.0f : f2 * 255.0f;
        float[] fArr6 = this.mBrushData;
        paint2.setARGB((int) f7, (int) (fArr6[1] * 255.0f), (int) (fArr6[2] * 255.0f), (int) (fArr6[3] * 255.0f));
        return true;
    }
        ...
        while (i3 < fArr.length) {
            ...
            if (i5 != 0) {
                ...
                if (i5 == 1) {
                    ...
                    if (i5 == 3) {
                        int i6 = i4 + 1;
                        float f2 = fArr[i4] * this.mScale;
                        int i7 = i6 + 1;
                        float f3 = this.mScale * fArr[i6];
                        int i8 = i7 + 1;
                        float f4 = this.mScale * fArr[i7];
                        int i9 = i8 + 1;
                        float f5 = this.mScale * fArr[i8];
                        int i10 = i9 + 1;
                        i2 = i10 + 1;
                        path.cubicTo(f2, f3, f4, f5, this.mScale * fArr[i9], fArr[i10] * this.mScale);
                    } else if (i5 == 4) {
                        int i11 = i4 + 1;
                        float f6 = fArr[i4] * this.mScale;
                        int i12 = i11 + 1;
                        float f7 = fArr[i11] * this.mScale;
                        int i13 = i12 + 1;
                        float f8 = fArr[i12] * this.mScale;
                        int i14 = i13 + 1;
