...
public abstract class ReactBaseTextShadowNode extends LayoutShadowNode {
    ...
    private static void buildSpannedFromShadowNode(ReactBaseTextShadowNode reactBaseTextShadowNode, SpannableStringBuilder spannableStringBuilder, List<SetSpanOperation> list, TextAttributes textAttributes, boolean z, Map<Integer, ReactShadowNode> map, int i) {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt instanceof ReactRawTextShadowNode) {
                ...
                if (styleWidth.unit == YogaUnit.POINT && styleHeight.unit == YogaUnit.POINT) {
                    float f2 = styleWidth.value;
                    float f3 = styleHeight.value;
                    spannableStringBuilder2.append("0");
                    list2.add(new SetSpanOperation(spannableStringBuilder.length() - 1, spannableStringBuilder.length(), new TextInlineViewPlaceholderSpan(reactTag, (int) f2, (int) f3)));
        ...
        if (length >= i2) {
            ...
            if (!((reactBaseTextShadowNode2.mTextShadowOffsetDx == BitmapDescriptorFactory.HUE_RED && reactBaseTextShadowNode2.mTextShadowOffsetDy == BitmapDescriptorFactory.HUE_RED && reactBaseTextShadowNode2.mTextShadowRadius == BitmapDescriptorFactory.HUE_RED) || Color.alpha(reactBaseTextShadowNode2.mTextShadowColor) == 0)) {
    ...
    public ReactBaseTextShadowNode() {
        ...
        this.mTextShadowRadius = BitmapDescriptorFactory.HUE_RED;
    ...
    public void setFontWeight(String str) {
        ...
        if (parseNumericFontWeight == 700 || "bold".equals(str)) {
            i = 1;
        } else if (parseNumericFontWeight != 400 && !BuildConfig.FLAVOR.equals(str)) {
