...
public class TextLayoutManager {
    ...
    private static void buildSpannableFromFragment(Context context, ReadableArray readableArray, SpannableStringBuilder spannableStringBuilder, List<SetSpanOperation> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            spannableStringBuilder.append(TextTransform.apply(map.getString(PreChatField.STRING), textAttributeProps.mTextTransform));
            ...
            if (length2 >= length) {
                ...
                if (!(textAttributeProps.mTextShadowOffsetDx == BitmapDescriptorFactory.HUE_RED && textAttributeProps.mTextShadowOffsetDy == BitmapDescriptorFactory.HUE_RED)) {
