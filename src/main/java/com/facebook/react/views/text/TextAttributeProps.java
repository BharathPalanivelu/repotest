...
public class TextAttributeProps {
    ...
    private float getPaddingProp(String str) {
        if (this.mProps.hasKey(ViewProps.PADDING)) {
            return PixelUtil.toPixelFromDIP(getFloatProp(ViewProps.PADDING, BitmapDescriptorFactory.HUE_RED));
        }
        return PixelUtil.toPixelFromDIP(getFloatProp(str, BitmapDescriptorFactory.HUE_RED));
    }
}
