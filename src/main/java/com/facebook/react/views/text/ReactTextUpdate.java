...
public class ReactTextUpdate {
    ...
    public ReactTextUpdate(Spannable spannable, int i, boolean z, float f2, float f3, float f4, float f5, int i2) {
        this(spannable, i, z, f2, f3, f4, f5, i2, 1, 0, -1, -1);
    }
    ...
    public ReactTextUpdate(Spannable spannable, int i, boolean z, float f2, float f3, float f4, float f5, int i2, int i3, int i4, int i5, int i6) {
