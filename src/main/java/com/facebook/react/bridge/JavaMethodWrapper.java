...
public class JavaMethodWrapper implements NativeModule.NativeMethod {
    ...
    public void invoke(JSInstance jSInstance, ReadableArray readableArray) {
        ...
        try {
            ...
            throw new NativeArgumentsParseException(e2.getMessage() + " (constructing arguments for " + str + " at argument index " + getAffectedRange(i, this.mArgumentExtractors[i2].getJSArgumentsNeeded()) + SQLBuilder.PARENTHESES_RIGHT, e2);
