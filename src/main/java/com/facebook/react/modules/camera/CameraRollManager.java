...
public class CameraRollManager extends ReactContextBaseJavaModule {
    ...
    public static final String[] PROJECTION = {FieldType.FOREIGN_ID_FIELD_SUFFIX, "mime_type", "bucket_display_name", "datetaken", "width", "height", "longitude", "latitude", "_data"};
    ...
    private static class SaveToCameraRoll extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(java.lang.Void... r14) {
            ...
            L_0x0033:
                ...
                java.io.InputStream r4 = com.google.firebase.perf.network.FirebasePerfUrlConnection.openStream(r4)     // Catch:{ IOException -> 0x0139, all -> 0x0136 }
    ...
    private static class GetMediaTask extends GuardedAsyncTask<Void, Void> {
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            try {
                ...
                this.mPromise.reject(CameraRollManager.ERROR_UNABLE_TO_LOAD_PERMISSION, "Could not get media: need READ_EXTERNAL_STORAGE permission", (Throwable) e2);
            } catch (Throwable th) {
                query.close();
                this.mPromise.resolve(writableNativeMap);
                throw th;
    ...
    private static boolean putImageInfo(ContentResolver contentResolver, Cursor cursor, WritableMap writableMap, int i, int i2, int i3, int i4, int i5) {
        ...
        if (string != null && string.startsWith("video")) {
            try {
                ...
                FLog.e(ReactConstants.TAG, "Could not get video metadata for " + parse.toString(), (Throwable) e3);
                return false;
            } catch (Throwable th) {
                mediaMetadataRetriever.release();
                openAssetFileDescriptor.close();
        ...
        if (f2 <= BitmapDescriptorFactory.HUE_RED || f3 <= BitmapDescriptorFactory.HUE_RED) {
            try {
                ...
                FLog.e(ReactConstants.TAG, "Could not get width/height for " + parse.toString(), (Throwable) e4);
                return false;
            }
        }
    ...
    private static void putLocationInfo(Cursor cursor, WritableMap writableMap, int i, int i2) {
        ...
        if (d2 > 0.0d || d3 > 0.0d) {
            ...
            writableMap.putMap(PlaceFields.LOCATION, writableNativeMap);
        }
    }
}
