        ...
        if (currentActivity == null) {
            ...
            UiThreadUtil.runOnUiThread(new GuardedRunnable(getReactApplicationContext()) {
                ...
                public void runGuarded() {
                    currentActivity.getWindow().addFlags(RNCartPanelDataEntity.NULL_VALUE);
                    if (z2) {
