...
public class CreateMountItem implements MountItem {
    ...
    public void execute(MountingManager mountingManager) {
        mountingManager.createViewWithProps(this.mContext, this.mComponent, this.mReactTag, (ReadableMap) null, this.mIsLayoutable);
    }

    public String toString() {
        return "CreateMountItem [" + this.mReactTag + "]";
    }
}
