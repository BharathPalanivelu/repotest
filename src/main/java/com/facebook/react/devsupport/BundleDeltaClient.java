...
public abstract class BundleDeltaClient {
    ...
    public abstract Pair<Boolean, NativeDeltaClient> processDelta(e eVar, File file) throws IOException;
    ...
    private static class BundleDeltaNativeClient extends BundleDeltaClient {
        ...
        /* access modifiers changed from: protected */
        public Pair<Boolean, NativeDeltaClient> processDelta(e eVar, File file) throws IOException {
