...
public class DevServerHelper {
    ...
    public void attachDebugger(final Context context, final String str) {
        new AsyncTask<Void, String, Boolean>() {
            ...
            public boolean doSync() {
                try {
                    FirebasePerfOkHttpClient.execute(new OkHttpClient().newCall(new Request.Builder().url(DevServerHelper.this.getInspectorAttachUrl(context, str)).build()));
                    return true;
                } catch (IOException e2) {
                    FLog.e(ReactConstants.TAG, "Failed to send attach request to Inspector", (Throwable) e2);
                    return false;
                }
            }
    ...
    public void symbolicateStackTrace(Iterable<StackFrame> iterable, final SymbolicationListener symbolicationListener) {
        try {
            ...
            FirebasePerfOkHttpClient.enqueue((Call) Assertions.assertNotNull(this.mClient.newCall(new Request.Builder().url(createSymbolicateURL).post(RequestBody.create(MediaType.parse(HttpConstants.ContentType.JSON), new JSONObject().put("stack", jSONArray).toString())).build())), new Callback() {
    ...
    public void openStackFrameCall(StackFrame stackFrame) {
        FirebasePerfOkHttpClient.enqueue((Call) Assertions.assertNotNull(this.mClient.newCall(new Request.Builder().url(createOpenStackFrameURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).post(RequestBody.create(MediaType.parse(HttpConstants.ContentType.JSON), stackFrame.toJSON().toString())).build())), new Callback() {
            public void onResponse(Call call, Response response) throws IOException {
            }
    ...
    public void isPackagerRunning(final PackagerStatusCallback packagerStatusCallback) {
        FirebasePerfOkHttpClient.enqueue(this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).build()), new Callback() {
            public void onFailure(Call call, IOException iOException) {
    ...
    private void enqueueOnChangeEndpointLongPolling() {
        FirebasePerfOkHttpClient.enqueue(((OkHttpClient) Assertions.assertNotNull(this.mOnChangePollingClient)).newCall(new Request.Builder().url(createOnChangeEndpointUrl()).tag(this).build()), new Callback() {
            public void onFailure(Call call, IOException iOException) {
    ...
    public java.io.File downloadBundleResourceFromUrlSync(java.lang.String r6, java.io.File r7) {
        /*
            ...
            okhttp3.Response r0 = com.google.firebase.perf.network.FirebasePerfOkHttpClient.execute(r0)     // Catch:{ Exception -> 0x006f }
        ...
        L_0x0031:
            return r1
        L_0x0032:
            e.u r2 = e.n.b((java.io.File) r7)     // Catch:{ all -> 0x0052 }
            okhttp3.ResponseBody r3 = r0.body()     // Catch:{ all -> 0x0050 }
            e.e r3 = r3.source()     // Catch:{ all -> 0x0050 }
            e.e r3 = e.n.a((e.v) r3)     // Catch:{ all -> 0x0050 }
            r3.a((e.u) r2)     // Catch:{ all -> 0x0050 }
