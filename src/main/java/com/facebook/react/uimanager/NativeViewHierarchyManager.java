...
public class NativeViewHierarchyManager {
    ...
    public synchronized void updateInstanceHandle(int i, long j) {
        ...
        try {
            ...
            String str = TAG;
            FLog.e(str, "Unable to update properties for view tag " + i, (Throwable) e2);
        }
        return;
    }
    ...
    public synchronized void createView(ThemedReactContext themedReactContext, int i, String str, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        try {
            ...
            View createViewWithProps = viewManager.createViewWithProps(themedReactContext, (ReactStylesDiffMap) null, this.mJSResponderHandler);
    ...
    private SparseIntArray getOrCreatePendingIndicesToDelete(int i) {
        SparseIntArray sparseIntArray = this.mTagsToPendingIndicesToDelete.get(Integer.valueOf(i));
        if (sparseIntArray != null) {
            return sparseIntArray;
        }
        SparseIntArray sparseIntArray2 = new SparseIntArray();
        this.mTagsToPendingIndicesToDelete.put(Integer.valueOf(i), sparseIntArray2);
