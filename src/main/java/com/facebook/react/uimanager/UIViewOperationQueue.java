...
public class UIViewOperationQueue {
    ...
    public void enqueueFindTargetForTouch(int i, float f2, float f3, Callback callback) {
        this.mOperations.add(new FindTargetForTouchOperation(i, f2, f3, callback));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x003f, code lost:
        ...
        com.facebook.systrace.Systrace.beginAsyncSection(0, "batchedExecutionTime", 0, com.path.android.jobqueue.JobManager.NS_PER_MS * r2);
