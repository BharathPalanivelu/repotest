...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    private final Spacing mDefaultPadding = new Spacing((float) BitmapDescriptorFactory.HUE_RED);
    ...
    public String toString() {
        return "[" + this.mViewClassName + SQLBuilder.BLANK + getReactTag() + "]";
    }
    ...
    public void setPaddingPercent(int i, float f2) {
        this.mPadding[i] = f2;
        this.mPaddingIsPercent[i] = !YogaConstants.isUndefined(f2);
        updatePadding();
    }
