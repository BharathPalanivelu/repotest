...
public class DefaultFlexByteArrayPoolParams {
    ...
    public static PoolParams get() {
        ...
        return new PoolParams(4194304, i * 4194304, generateBuckets(DEFAULT_MIN_BYTE_ARRAY_SIZE, 4194304, i), DEFAULT_MIN_BYTE_ARRAY_SIZE, 4194304, DEFAULT_MAX_NUM_THREADS);
    }
}
