...
public class ImagePipeline {
    ...
    public DataSource<Boolean> isInDiskCache(ImageRequest imageRequest) {
        ...
        this.mMainBufferedDiskCache.contains(encodedCacheKey).b(new h<Boolean, k<Boolean>>() {
            public k<Boolean> then(k<Boolean> kVar) throws Exception {
                if (kVar.d() || kVar.e() || !kVar.f().booleanValue()) {
                    return ImagePipeline.this.mSmallImageBufferedDiskCache.contains(encodedCacheKey);
                }
                return k.a(true);
            }
        }).a(new h<Boolean, Void>() {
            public Void then(k<Boolean> kVar) throws Exception {
                create.setResult(Boolean.valueOf(!kVar.d() && !kVar.e() && kVar.f().booleanValue()));
                return null;
            }
        });
        return create;
    ...
    private <T> com.facebook.datasource.DataSource<com.facebook.common.references.CloseableReference<T>> submitFetchRequest(com.facebook.imagepipeline.producers.Producer<com.facebook.common.references.CloseableReference<T>> r11, com.facebook.imagepipeline.request.ImageRequest r12, com.facebook.imagepipeline.request.ImageRequest.RequestLevel r13, java.lang.Object r14, com.facebook.imagepipeline.listener.RequestListener r15) {
        /*
            r10 = this;
