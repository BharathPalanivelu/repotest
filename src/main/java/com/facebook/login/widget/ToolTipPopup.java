...
public class ToolTipPopup {
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            registerObserver();
            this.mPopupContent.measure(View.MeasureSpec.makeMeasureSpec(width, RNCartPanelDataEntity.NULL_VALUE), View.MeasureSpec.makeMeasureSpec(height, RNCartPanelDataEntity.NULL_VALUE));
