...
public class GraphResponse {
    ...
    public com.facebook.GraphRequest getRequestForPagedResults(com.facebook.GraphResponse.PagingDirection r5) {
        ...
        L_0x001f:
            r5 = r1
        L_0x0020:
            boolean r0 = com.facebook.internal.Utility.isNullOrEmpty((java.lang.String) r5)
        ...
        L_0x0036:
            ...
            r0.<init>((com.facebook.AccessToken) r2, (java.net.URL) r3)     // Catch:{ MalformedURLException -> 0x0047 }
            return r0
        L_0x0047:
            return r1
        */
    ...
    static List<GraphResponse> fromHttpConnection(HttpURLConnection httpURLConnection, GraphRequestBatch graphRequestBatch) {
        ...
        try {
            ...
            return constructErrorResponses(graphRequestBatch, httpURLConnection, new FacebookException((Throwable) e3));
        } finally {
