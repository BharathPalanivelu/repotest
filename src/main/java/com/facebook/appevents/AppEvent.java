...
class AppEvent implements Serializable {
    ...
    private static JSONObject getJSONObjectForAppEvent(String str, String str2, Double d2, Bundle bundle, boolean z, UUID uuid) throws FacebookException, JSONException {
    ...
    private static String md5Checksum(String str) {
        try {
            ...
            Utility.logd("Failed to generate checksum: ", (Exception) e3);
            return "1";
        }
    }
}
