...
public abstract class RoundedDrawable extends Drawable implements Rounded, TransformAwareDrawable {
    ...
    public void setRadius(float f2) {
        boolean z = false;
        Preconditions.checkState(f2 >= BitmapDescriptorFactory.HUE_RED);
    ...
    public void setRadii(float[] fArr) {
        if (fArr == null) {
            Arrays.fill(this.mCornerRadii, BitmapDescriptorFactory.HUE_RED);
    ...
    public void updatePath() {
        ...
        if (this.mIsPathDirty) {
            ...
            this.mPath.reset();
            float f4 = this.mPadding + (this.mScaleDownInsideBorders ? this.mBorderWidth : BitmapDescriptorFactory.HUE_RED);
