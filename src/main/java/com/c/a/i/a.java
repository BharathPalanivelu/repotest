...
public final class a {
    ...
    private static final AtomicReference<byte[]> f6232a = new AtomicReference<>();
    ...
    public static byte[] a(ByteBuffer byteBuffer) {
        b c2 = c(byteBuffer);
        if (c2 != null && c2.f6239a == 0 && c2.f6240b == c2.f6241c.length) {
    ...
    private static class C0111a extends InputStream {

        /* renamed from: a  reason: collision with root package name */
        private final ByteBuffer f6233a;
        ...
        public C0111a(ByteBuffer byteBuffer) {
            this.f6233a = byteBuffer;
        }

        public int available() throws IOException {
            return this.f6233a.remaining();
        }

        public int read() throws IOException {
            if (!this.f6233a.hasRemaining()) {
                return -1;
            }
        ...
        public synchronized void mark(int i) {
            this.f6234b = this.f6233a.position();
        }
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            ...
            this.f6233a.get(bArr, i, min);
            return min;
        }

        public synchronized void reset() throws IOException {
            if (this.f6234b != -1) {
                this.f6233a.position(this.f6234b);
            } else {
        ...
        public long skip(long j) throws IOException {
            ...
            ByteBuffer byteBuffer = this.f6233a;
