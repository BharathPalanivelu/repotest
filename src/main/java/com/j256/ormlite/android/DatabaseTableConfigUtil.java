...
public class DatabaseTableConfigUtil {
    ...
    private static int[] lookupClasses() {
        /*
            ...
            java.lang.Class r1 = java.lang.Class.forName(r1)     // Catch:{  }
            java.lang.Class<?> r2 = annotationFactoryClazz     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.String r3 = "elements"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r3)     // Catch:{ ClassNotFoundException -> 0x0090 }
            elementsField = r2     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.reflect.Field r2 = elementsField     // Catch:{ ClassNotFoundException -> 0x0090 }
            r3 = 1
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.String r4 = "name"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x0090 }
            nameField = r2     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.reflect.Field r2 = nameField     // Catch:{ ClassNotFoundException -> 0x0090 }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.Class<?> r2 = annotationMemberClazz     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.String r4 = "value"
            java.lang.reflect.Field r2 = r2.getDeclaredField(r4)     // Catch:{ ClassNotFoundException -> 0x0090 }
            valueField = r2     // Catch:{ ClassNotFoundException -> 0x0090 }
            java.lang.reflect.Field r2 = valueField     // Catch:{ ClassNotFoundException -> 0x0090 }
            r2.setAccessible(r3)     // Catch:{ ClassNotFoundException -> 0x0090 }
