...
public class MappedCreate<T, ID> extends BaseMappedStatement<T, ID> {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0066 A[Catch:{ SQLException -> 0x0122, SQLException -> 0x013a }] */
    /* JADX WARNING: Removed duplicated region for block: B:50:0x00ce A[Catch:{ SQLException -> 0x0122, SQLException -> 0x013a }] */
    /* JADX WARNING: Removed duplicated region for block: B:52:0x00d5 A[Catch:{ SQLException -> 0x0122, SQLException -> 0x013a }] */
    ...
    public int insert(com.j256.ormlite.db.DatabaseType r11, com.j256.ormlite.support.DatabaseConnection r12, T r13, com.j256.ormlite.dao.ObjectCache r14) throws java.sql.SQLException {
        ...
        L_0x005d:
            r11 = r3
        L_0x005e:
            com.j256.ormlite.table.TableInfo r1 = r10.tableInfo     // Catch:{ SQLException -> 0x013a }
            boolean r1 = r1.isForeignAutoCreate()     // Catch:{ SQLException -> 0x013a }
            if (r1 == 0) goto L_0x008f
            com.j256.ormlite.table.TableInfo r1 = r10.tableInfo     // Catch:{ SQLException -> 0x013a }
            com.j256.ormlite.field.FieldType[] r1 = r1.getFieldTypes()     // Catch:{ SQLException -> 0x013a }
            int r4 = r1.length     // Catch:{ SQLException -> 0x013a }
            r5 = 0
        L_0x006e:
            if (r5 >= r4) goto L_0x008f
            r6 = r1[r5]     // Catch:{ SQLException -> 0x013a }
            boolean r7 = r6.isForeignAutoCreate()     // Catch:{ SQLException -> 0x013a }
            if (r7 != 0) goto L_0x0079
            goto L_0x008c
        L_0x0079:
            java.lang.Object r7 = r6.extractRawJavaFieldValue(r13)     // Catch:{ SQLException -> 0x013a }
            if (r7 == 0) goto L_0x008c
            com.j256.ormlite.field.FieldType r8 = r6.getForeignIdField()     // Catch:{ SQLException -> 0x013a }
            boolean r8 = r8.isObjectsFieldValueDefault(r7)     // Catch:{ SQLException -> 0x013a }
            if (r8 == 0) goto L_0x008c
            r6.createWithForeignDao(r7)     // Catch:{ SQLException -> 0x013a }
        L_0x008c:
            int r5 = r5 + 1
            goto L_0x006e
        L_0x008f:
            java.lang.Object[] r1 = r10.getFieldObjects(r13)     // Catch:{ SQLException -> 0x013a }
            int r4 = r10.versionFieldTypeIndex     // Catch:{ SQLException -> 0x013a }
            if (r4 < 0) goto L_0x00b0
            int r4 = r10.versionFieldTypeIndex     // Catch:{ SQLException -> 0x013a }
            r4 = r1[r4]     // Catch:{ SQLException -> 0x013a }
            if (r4 != 0) goto L_0x00b0
            com.j256.ormlite.field.FieldType[] r4 = r10.argFieldTypes     // Catch:{ SQLException -> 0x013a }
            int r5 = r10.versionFieldTypeIndex     // Catch:{ SQLException -> 0x013a }
            r4 = r4[r5]     // Catch:{ SQLException -> 0x013a }
            java.lang.Object r5 = r4.moveToNextValue(r3)     // Catch:{ SQLException -> 0x013a }
            int r6 = r10.versionFieldTypeIndex     // Catch:{ SQLException -> 0x013a }
            java.lang.Object r4 = r4.convertJavaFieldToSqlArgValue(r5)     // Catch:{ SQLException -> 0x013a }
            r1[r6] = r4     // Catch:{ SQLException -> 0x013a }
            goto L_0x00b1
        L_0x00b0:
            r5 = r3
        L_0x00b1:
            java.lang.String r4 = r10.statement     // Catch:{ SQLException -> 0x0122 }
            com.j256.ormlite.field.FieldType[] r6 = r10.argFieldTypes     // Catch:{ SQLException -> 0x0122 }
            int r12 = r12.insert(r4, r1, r6, r11)     // Catch:{ SQLException -> 0x0122 }
            com.j256.ormlite.logger.Logger r4 = logger     // Catch:{ SQLException -> 0x013a }
            java.lang.String r6 = "insert data with statement '{}' and {} args, changed {} rows"
            java.lang.String r7 = r10.statement     // Catch:{ SQLException -> 0x013a }
            int r8 = r1.length     // Catch:{ SQLException -> 0x013a }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ SQLException -> 0x013a }
            java.lang.Integer r9 = java.lang.Integer.valueOf(r12)     // Catch:{ SQLException -> 0x013a }
            r4.debug((java.lang.String) r6, (java.lang.Object) r7, (java.lang.Object) r8, (java.lang.Object) r9)     // Catch:{ SQLException -> 0x013a }
            int r4 = r1.length     // Catch:{ SQLException -> 0x013a }
            if (r4 <= 0) goto L_0x00d3
            com.j256.ormlite.logger.Logger r4 = logger     // Catch:{ SQLException -> 0x013a }
            r4.trace((java.lang.String) r0, (java.lang.Object) r1)     // Catch:{ SQLException -> 0x013a }
        L_0x00d3:
            if (r12 <= 0) goto L_0x0121
            if (r5 == 0) goto L_0x00e0
            com.j256.ormlite.field.FieldType[] r0 = r10.argFieldTypes     // Catch:{ SQLException -> 0x013a }
            int r1 = r10.versionFieldTypeIndex     // Catch:{ SQLException -> 0x013a }
            r0 = r0[r1]     // Catch:{ SQLException -> 0x013a }
            r0.assignField(r13, r5, r2, r3)     // Catch:{ SQLException -> 0x013a }
        L_0x00e0:
            if (r11 == 0) goto L_0x0108
            java.lang.Number r11 = r11.getKey()     // Catch:{ SQLException -> 0x013a }
            if (r11 == 0) goto L_0x0100
            long r0 = r11.longValue()     // Catch:{ SQLException -> 0x013a }
            r2 = 0
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 == 0) goto L_0x00f8
            java.lang.String r0 = "keyholder"
            r10.assignIdValue(r13, r11, r0, r14)     // Catch:{ SQLException -> 0x013a }
            goto L_0x0108
        L_0x00f8:
            java.sql.SQLException r11 = new java.sql.SQLException     // Catch:{ SQLException -> 0x013a }
            java.lang.String r12 = "generated-id key must not be 0 value"
            r11.<init>(r12)     // Catch:{ SQLException -> 0x013a }
            throw r11     // Catch:{ SQLException -> 0x013a }
        L_0x0100:
            java.sql.SQLException r11 = new java.sql.SQLException     // Catch:{ SQLException -> 0x013a }
            java.lang.String r12 = "generated-id key was not set by the update call"
            r11.<init>(r12)     // Catch:{ SQLException -> 0x013a }
            throw r11     // Catch:{ SQLException -> 0x013a }
        L_0x0108:
            if (r14 == 0) goto L_0x0121
            com.j256.ormlite.table.TableInfo r11 = r10.tableInfo     // Catch:{ SQLException -> 0x013a }
            com.j256.ormlite.field.FieldType[] r11 = r11.getForeignCollections()     // Catch:{ SQLException -> 0x013a }
            boolean r11 = r10.foreignCollectionsAreAssigned(r11, r13)     // Catch:{ SQLException -> 0x013a }
            if (r11 == 0) goto L_0x0121
            com.j256.ormlite.field.FieldType r11 = r10.idField     // Catch:{ SQLException -> 0x013a }
            java.lang.Object r11 = r11.extractJavaFieldValue(r13)     // Catch:{ SQLException -> 0x013a }
            java.lang.Class r0 = r10.clazz     // Catch:{ SQLException -> 0x013a }
            r14.put(r0, r11, r13)     // Catch:{ SQLException -> 0x013a }
        L_0x0121:
            return r12
        L_0x0122:
            r11 = move-exception
            com.j256.ormlite.logger.Logger r12 = logger     // Catch:{ SQLException -> 0x013a }
            java.lang.String r14 = "insert data with statement '{}' and {} args, threw exception: {}"
            java.lang.String r2 = r10.statement     // Catch:{ SQLException -> 0x013a }
            int r3 = r1.length     // Catch:{ SQLException -> 0x013a }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r3)     // Catch:{ SQLException -> 0x013a }
            r12.debug((java.lang.String) r14, (java.lang.Object) r2, (java.lang.Object) r3, (java.lang.Object) r11)     // Catch:{ SQLException -> 0x013a }
            int r12 = r1.length     // Catch:{ SQLException -> 0x013a }
            if (r12 <= 0) goto L_0x0139
            com.j256.ormlite.logger.Logger r12 = logger     // Catch:{ SQLException -> 0x013a }
            r12.trace((java.lang.String) r0, (java.lang.Object) r1)     // Catch:{ SQLException -> 0x013a }
        L_0x0139:
            throw r11     // Catch:{ SQLException -> 0x013a }
        L_0x013a:
            r11 = move-exception
