    ...
    public void c(byte[] bArr, int i) throws IOException {
        ...
        if (b(responseCommon)) {
            ...
            if (responseCommon.order.order != null) {
                if (responseCommon.order.order.extinfo != null) {
                    i2 = b.a(com.shopee.app.d.b.c.a(responseCommon.order.order.extinfo.i()).release_time);
                }
            ...
            com.garena.android.appkit.b.b.a("ORDER_ESCROW_EXTENDED", (a) new d(responseCommon.orderid, i2), b.a.NETWORK_BUS);
        }
    }
