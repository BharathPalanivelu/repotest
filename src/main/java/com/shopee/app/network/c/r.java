...
public class r extends c {
    ...
    public void c(byte[] bArr, int i) throws IOException {
        ...
        if (a(responseCommon)) {
            b.a("FOLLOW_SUCCESS", new a(responseCommon.requestid), b.a.NETWORK_BUS);
    ...
    private void b(ResponseCommon responseCommon) {
        b.a("FOLLOW_ERROR", new a(new com.shopee.app.network.c.d.a(responseCommon.errcode.intValue(), responseCommon.err_message, responseCommon)), b.a.NETWORK_BUS);
    }
