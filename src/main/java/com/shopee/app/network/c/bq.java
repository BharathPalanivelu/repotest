...
public class bq extends c {
    ...
    public void c(byte[] bArr, int i) throws IOException {
        ...
        if (b(responseCommon)) {
            b.a("UPDATE_SHOP_INFO", new a(), b.a.NETWORK_BUS);
        }
    }

    private void a(ResponseCommon responseCommon) {
        b.a("UPDATE_SHOP_INFO_ERROR", new a(new com.shopee.app.network.c.d.a(responseCommon.errcode.intValue(), responseCommon.err_message, responseCommon)), b.a.NETWORK_BUS);
    }
