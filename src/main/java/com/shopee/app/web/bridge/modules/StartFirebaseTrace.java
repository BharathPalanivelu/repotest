...
public final class StartFirebaseTrace extends WebBridgeModule {
    private final a firebasePerf;

    /* access modifiers changed from: protected */
    public String getBridgeName() {
        return "startFirebaseTrace";
    }
    ...
    public StartFirebaseTrace(Context context, a aVar) {
        super(context);
        j.b(context, "context");
    ...
    public void onBridgeInvoked(Object obj) {
        if (obj != null) {
            BridgeResult<?> a2 = this.firebasePerf.a((StartTraceInfo) obj, false);
        ...
        throw new m("null cannot be cast to non-null type com.shopee.app.web.protocol.StartTraceInfo");
    }
}
