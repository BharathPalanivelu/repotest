...
public final class ReactTransparentActivity_ extends j implements org.a.a.b.a {
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private androidx.fragment.app.Fragment f18549e;

        public a(Context context) {
            super(context, ReactTransparentActivity_.class);
        }

        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f18549e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f18548d;
                if (fragment2 != null) {
