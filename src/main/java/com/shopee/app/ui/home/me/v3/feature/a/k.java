...
public final class k extends n {
    ...
    public static final k f22568b = new k();

    private k() {
        super("activity", "my_voucher_button");
    }

    public boolean a(i iVar) {
        j.b(iVar, "metaData");
        return iVar.o().a("voucher_wallet");
    }

    public static final class a extends OptionRow implements h {

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Context f22569b;

        /* renamed from: com.shopee.app.ui.home.me.v3.feature.a.k$a$a  reason: collision with other inner class name */
        static final class C0336a extends d.d.b.k implements d.d.a.a<p> {
            final /* synthetic */ MeFeature $meFeature;
            final /* synthetic */ i $metaData;

            /* JADX INFO: super call moved to the top of the method (can break code semantics) */
            C0336a(i iVar, MeFeature meFeature) {
                super(0);
                this.$metaData = iVar;
        ...
        public void a(i iVar, MeFeature meFeature) {
            ...
            f.a(this, iVar, new C0336a(iVar, meFeature));
        }

        public void a(MeFeature meFeature) {
            setIcon(this.f22569b.getResources().getDrawable(R.drawable.icon_voucher));
            setText(this.f22569b.getResources().getString(R.string.sp_voucher_wallet));
        }
    }
