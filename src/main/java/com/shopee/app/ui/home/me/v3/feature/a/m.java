...
public final class m extends n {
    ...
    public static final m f22572b = new m();
    ...
    private m() {
        super("activity", "recently_viewed");
    }

    public static final class a extends OptionRow implements h {

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Context f22573b;

        /* renamed from: com.shopee.app.ui.home.me.v3.feature.a.m$a$a  reason: collision with other inner class name */
        static final class C0338a extends k implements d.d.a.a<p> {
            final /* synthetic */ MeFeature $meFeature;
            final /* synthetic */ i $metaData;

            /* JADX INFO: super call moved to the top of the method (can break code semantics) */
            C0338a(i iVar, MeFeature meFeature) {
                super(0);
                this.$metaData = iVar;
        ...
        public void a(i iVar, MeFeature meFeature) {
            ...
            f.a(this, iVar, new C0338a(iVar, meFeature));
        }

        public void a(MeFeature meFeature) {
            setIcon(this.f22573b.getResources().getDrawable(R.drawable.ic_me_recently_viewed));
            setText(this.f22573b.getResources().getString(R.string.sp_label_recently_viewed));
        }
    }
