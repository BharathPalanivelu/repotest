...
public final class n extends com.shopee.app.ui.home.me.v3.feature.n {

    /* renamed from: b  reason: collision with root package name */
    public static final n f22574b = new n();

    private n() {
        super("activity", "referrer_entrance");
    }

    public boolean a(i iVar) {
        j.b(iVar, "metaData");
        if (iVar instanceof b.a) {
            return iVar.p().showMePageReferral();
        }
        return false;
    }
    ...
    public static final class a extends OptionRow implements h {
        ...
        /* renamed from: com.shopee.app.ui.home.me.v3.feature.a.n$a$a  reason: collision with other inner class name */
        static final class C0339a extends k implements d.d.a.a<p> {
            final /* synthetic */ MeFeature $meFeature;
            final /* synthetic */ i $metaData;

            /* JADX INFO: super call moved to the top of the method (can break code semantics) */
            C0339a(i iVar, MeFeature meFeature) {
                super(0);
                this.$metaData = iVar;
        ...
        public void a(i iVar, MeFeature meFeature) {
            ...
            f.a(this, iVar, new C0339a(iVar, meFeature));
        }

        public void a(MeFeature meFeature) {
            setIcon(this.f22575b.getResources().getDrawable(R.drawable.ic_me_referrals));
            setText(this.f22575b.getResources().getString(R.string.sp_label_me_referrals));
        }
    }
