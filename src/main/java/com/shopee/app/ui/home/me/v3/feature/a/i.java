...
public final class i extends n {
    ...
    public static final i f22564b = new i();
    ...
    private i() {
        super("activity", "my_rating");
    }

    public static final class a extends OptionRow implements h {

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Context f22565b;

        /* renamed from: com.shopee.app.ui.home.me.v3.feature.a.i$a$a  reason: collision with other inner class name */
        static final class C0334a extends k implements d.d.a.a<p> {
            final /* synthetic */ MeFeature $meFeature;
            final /* synthetic */ com.shopee.app.ui.home.me.v3.feature.i $metaData;

            /* JADX INFO: super call moved to the top of the method (can break code semantics) */
            C0334a(com.shopee.app.ui.home.me.v3.feature.i iVar, MeFeature meFeature) {
                super(0);
                this.$metaData = iVar;
            ...
            public final void a() {
                this.$metaData.k().a(this.$metaData.j().getUserId(), false);
                d h = this.$metaData.h();
                if (h != null) {
        ...
        public void a(com.shopee.app.ui.home.me.v3.feature.i iVar, MeFeature meFeature) {
            ...
            f.a(this, iVar, new C0334a(iVar, meFeature));
        }

        public void a(MeFeature meFeature) {
            setIcon(this.f22565b.getResources().getDrawable(R.drawable.ic_me_rating));
            setText(this.f22565b.getResources().getString(R.string.sp_buyer_rating));
        }
    }
