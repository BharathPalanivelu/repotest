...
public final class TutorialActivity_ extends f implements org.a.a.b.a {

    /* renamed from: b  reason: collision with root package name */
    private final c f25689b = new c();

    private void c(Bundle bundle) {
    }

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f25689b);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f25689b.a((org.a.a.b.a) this);
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private Fragment f25690d;

        /* renamed from: e  reason: collision with root package name */
        private androidx.fragment.app.Fragment f25691e;
        ...
        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f25691e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f25690d;
                if (fragment2 != null) {
