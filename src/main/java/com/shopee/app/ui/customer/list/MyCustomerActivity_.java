...
public final class MyCustomerActivity_ extends a implements org.a.a.b.a {

    /* renamed from: a  reason: collision with root package name */
    private final c f21391a = new c();

    private void c(Bundle bundle) {
    }

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f21391a);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f21391a.a((org.a.a.b.a) this);
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private androidx.fragment.app.Fragment f21393e;

        public a(Context context) {
            super(context, MyCustomerActivity_.class);
        }

        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f21393e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f21392d;
                if (fragment2 != null) {
