...
public final class ShopAssistantActivity_ extends b implements org.a.a.b.a {

    /* renamed from: a  reason: collision with root package name */
    private final c f25373a = new c();

    private void c(Bundle bundle) {
    }

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f25373a);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f25373a.a((org.a.a.b.a) this);
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private androidx.fragment.app.Fragment f25375e;

        public a(Context context) {
            super(context, ShopAssistantActivity_.class);
        }

        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f25375e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f25374d;
                if (fragment2 != null) {
