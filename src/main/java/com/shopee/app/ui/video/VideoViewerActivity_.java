...
public final class VideoViewerActivity_ extends d implements org.a.a.b.a {

    /* renamed from: b  reason: collision with root package name */
    private final c f25730b = new c();

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f25730b);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f25730b.a((org.a.a.b.a) this);
    }
    ...
    private void l() {
        ...
        if (extras != null && extras.containsKey("videoURL")) {
            this.f25772a = extras.getString("videoURL");
        }
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private Fragment f25731d;

        /* renamed from: e  reason: collision with root package name */
        private androidx.fragment.app.Fragment f25732e;

        public a(Context context) {
            super(context, VideoViewerActivity_.class);
        }

        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f25732e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f25731d;
                if (fragment2 != null) {
