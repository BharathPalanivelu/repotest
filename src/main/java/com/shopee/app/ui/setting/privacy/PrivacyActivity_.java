...
public final class PrivacyActivity_ extends a implements org.a.a.b.a {

    /* renamed from: a  reason: collision with root package name */
    private final c f25309a = new c();

    private void c(Bundle bundle) {
    }

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f25309a);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f25309a.a((org.a.a.b.a) this);
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private androidx.fragment.app.Fragment f25311e;

        public a(Context context) {
            super(context, PrivacyActivity_.class);
        }

        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f25311e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f25310d;
                if (fragment2 != null) {
