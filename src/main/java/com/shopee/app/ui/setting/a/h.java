...
public final class h extends g implements org.a.a.b.a {

    /* renamed from: a  reason: collision with root package name */
    private final c f25135a = new c();

    private void c(Bundle bundle) {
    }

    public void onCreate(Bundle bundle) {
        c a2 = c.a(this.f25135a);
        c(bundle);
    ...
    public void setContentView(int i) {
        ...
        this.f25135a.a((org.a.a.b.a) this);
    }
    ...
    public static class a extends org.a.a.a.a<a> {
        ...
        private Fragment f25136d;

        /* renamed from: e  reason: collision with root package name */
        private androidx.fragment.app.Fragment f25137e;
        ...
        public d a(int i) {
            androidx.fragment.app.Fragment fragment = this.f25137e;
            if (fragment != null) {
                fragment.startActivityForResult(this.f7170c, i);
            } else {
                Fragment fragment2 = this.f25136d;
                if (fragment2 != null) {
