...
public class b extends a {
    ...
    public b(OrderDetail orderDetail) {
        super(orderDetail);
        this.f15989c = orderDetail;
    }

    public long a() {
        return this.f15989c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                b.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(b.this.f15989c));
            }
        });
    }
    ...
    public a.C0251a i() {
        return new a.C0251a(a((int) R.string.sp_label_buy_again), 0, new View.OnClickListener() {
            public void onClick(View view) {
                b.this.f15981b.a("ORDER_CANCELLED_BUY", new com.garena.android.appkit.b.a(b.this.f15989c));
            }
        });
    }
