...
public class h extends a {
    ...
    public OrderDetail f16186c;

    public h(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16186c = orderDetail;
    }

    public long a() {
        return this.f16186c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                h.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(h.this.f16186c));
            }
        });
    }
