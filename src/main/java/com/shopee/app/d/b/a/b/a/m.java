...
public class m extends a {
    ...
    public OrderDetail f16196c;

    public m(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16196c = orderDetail;
    }

    public long a() {
        return this.f16196c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                m.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(m.this.f16196c));
            }
        });
    }
    ...
    public String k() {
        return a((int) R.string.sp_cancel_fail_cod_seller);
    }
}
