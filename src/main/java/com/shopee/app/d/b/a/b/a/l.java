...
public class l extends a {
    ...
    public OrderDetail f16194c;

    public l(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16194c = orderDetail;
    }

    public long a() {
        return this.f16194c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                l.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(l.this.f16194c));
            }
        });
    }
