...
public class n extends a {
    ...
    public OrderDetail f16022c;

    public n(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16022c = orderDetail;
    }

    public long a() {
        return this.f16022c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return ar.f().e().orderLogicProcessor().f(this.f16022c, this.f15981b);
    }

    public a.C0251a i() {
        return new a.C0251a(a((int) R.string.sp_label_buy_again), 0, new View.OnClickListener() {
            public void onClick(View view) {
                n.this.f15981b.a("ORDER_CANCELLED_BUY", new com.garena.android.appkit.b.a(n.this.f16022c));
            }
        });
    }
