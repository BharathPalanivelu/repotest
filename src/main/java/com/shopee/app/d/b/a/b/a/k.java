...
public class k extends a {
    ...
    public OrderDetail f16192c;

    public k(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16192c = orderDetail;
    }

    public long a() {
        return this.f16192c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                k.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(k.this.f16192c));
            }
        });
    }
