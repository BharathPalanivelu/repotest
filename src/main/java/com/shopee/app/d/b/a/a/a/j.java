...
public class j extends a {
    ...
    public OrderDetail f16011c;

    public j(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16011c = orderDetail;
    }

    public long a() {
        return this.f16011c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                j.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(j.this.f16011c));
            }
        });
    }
    ...
    public a.C0251a i() {
        return new a.C0251a(a((int) R.string.sp_label_buy_again), 0, new View.OnClickListener() {
            public void onClick(View view) {
                j.this.f15981b.a("ORDER_CANCELLED_BUY", new com.garena.android.appkit.b.a(j.this.f16011c));
            }
        });
    }
