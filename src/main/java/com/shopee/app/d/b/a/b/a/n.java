...
public class n extends a {
    ...
    public OrderDetail f16198c;

    public n(OrderDetail orderDetail) {
        super(orderDetail);
        this.f16198c = orderDetail;
    }

    public long a() {
        return this.f16198c.getOrderId();
    }
    ...
    public a.C0251a d() {
        return new a.C0251a(a((int) R.string.sp_check_details), 0, new View.OnClickListener() {
            public void onClick(View view) {
                n.this.f15981b.a("ORDER_GOTO_CANCEL_DETAIL", new com.garena.android.appkit.b.a(n.this.f16198c));
            }
        });
    }
