...
public enum d {
    ...
    private static final Map<Integer, d> f14498a = null;

    /* renamed from: b  reason: collision with root package name */
    private static final Map<String, d> f14499b = null;
    ...
    static {
        ...
        for (d dVar : values()) {
            for (int valueOf : dVar.values) {
                f14498a.put(Integer.valueOf(valueOf), dVar);
            }
            f14499b.put(dVar.name(), dVar);
            for (String put : dVar.otherEncodingNames) {
                f14499b.put(put, dVar);
            }
        }
    }
    ...
    public static d getCharacterSetECIByValue(int i) throws m {
        if (i >= 0 && i < 900) {
            return f14498a.get(Integer.valueOf(i));
        }
        throw m.a();
    }

    public static d getCharacterSetECIByName(String str) {
        return f14499b.get(str);
    }
}
