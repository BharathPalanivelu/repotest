...
final class l {
    ...
    private final List<int[]> f14607a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List<String> f14608b = new ArrayList();
    ...
    public String a(String str) {
        ...
        int size = this.f14607a.size();
        for (int i = 0; i < size; i++) {
            int[] iArr = this.f14607a.get(i);
            int i2 = iArr[0];
            if (parseInt < i2) {
                return null;
            }
    ...
    private synchronized void a() {
        if (this.f14607a.isEmpty()) {
            ...
            a(new int[]{471}, Country.COUNTRY_TW);
            a(new int[]{474}, "EE");
            a(new int[]{475}, "LV");
            a(new int[]{476}, "AZ");
            a(new int[]{477}, "LT");
            a(new int[]{478}, "UZ");
            a(new int[]{479}, "LK");
            a(new int[]{480}, Country.COUNTRY_PH);
            a(new int[]{481}, "BY");
            a(new int[]{482}, "UA");
            a(new int[]{484}, "MD");
            a(new int[]{485}, "AM");
            a(new int[]{486}, "GE");
            a(new int[]{487}, "KZ");
            a(new int[]{489}, Country.COUNTRY_HK);
            ...
            a(new int[]{624}, "LY");
            a(new int[]{625}, "JO");
            a(new int[]{626}, Country.COUNTRY_IR);
            a(new int[]{627}, "KW");
            a(new int[]{628}, "SA");
            a(new int[]{629}, "AE");
            ...
            a(new int[]{880}, "KR");
            a(new int[]{885}, Country.COUNTRY_TH);
            a(new int[]{888}, Country.COUNTRY_SG);
            a(new int[]{890}, "IN");
            a(new int[]{893}, Country.COUNTRY_VN);
            a(new int[]{896}, "PK");
            a(new int[]{899}, "ID");
            a(new int[]{900, 919}, "AT");
            a(new int[]{930, 939}, "AU");
            a(new int[]{940, 949}, "AZ");
            a(new int[]{955}, Country.COUNTRY_MY);
            a(new int[]{958}, "MO");
        }
    }
}
