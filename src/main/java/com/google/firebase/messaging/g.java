...
final class g implements Closeable {
    ...
    private final URL f14216a;

    /* renamed from: b  reason: collision with root package name */
    private Task<Bitmap> f14217b;

    /* renamed from: c  reason: collision with root package name */
    private volatile InputStream f14218c;
    ...
    public final void a(Executor executor) {
        this.f14217b = Tasks.call(executor, new h(this));
    }

    public final Task<Bitmap> a() {
        return (Task) Preconditions.checkNotNull(this.f14217b);
    }
    ...
    public final android.graphics.Bitmap b() throws java.io.IOException {
        /*
            ...
            java.net.URL r0 = r9.f14216a     // Catch:{ IOException -> 0x00b6 }
            ...
            r9.f14218c = r0     // Catch:{ Throwable -> 0x00a1, all -> 0x009e }
            ...
            java.net.URL r5 = r9.f14216a     // Catch:{ Throwable -> 0x00a1, all -> 0x009e }
        ...
        L_0x0073:
            return r3
        L_0x0074:
            java.net.URL r3 = r9.f14216a     // Catch:{ Throwable -> 0x00a1, all -> 0x009e }
        ...
        L_0x00b6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.messaging.g.b():android.graphics.Bitmap");
    }

    public final void close() {
        zzk.zza(this.f14218c);
    }
