...
public class a<T> {
    ...
    a(Type type2) {
        this.type = b.d((Type) com.google.a.b.a.a(type2));
        this.rawType = b.e(this.type);
        this.hashCode = this.type.hashCode();
    }
    ...
    public boolean isAssignableFrom(Type type2) {
        ...
        if (type3 instanceof Class) {
            return this.rawType.isAssignableFrom(b.e(type2));
        }
        ...
        } else if (!this.rawType.isAssignableFrom(b.e(type2)) || !isAssignableFrom(type2, (GenericArrayType) this.type)) {
            return false;
        } else {
            return true;
        }
    ...
    private static boolean isAssignableFrom(Type type2, ParameterizedType parameterizedType, Map<String, Type> map) {
        ...
        for (Type isAssignableFrom : e2.getGenericInterfaces()) {
