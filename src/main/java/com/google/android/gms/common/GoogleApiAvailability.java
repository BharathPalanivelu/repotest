...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    static void zaa(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof c) {
            SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((c) activity).getSupportFragmentManager(), str);
            return;
        }
    ...
    private final void zaa(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            i.d a2 = new i.d(context).f(true).e(true).a((CharSequence) errorNotificationTitle).a((i.g) new i.c().b(errorNotificationMessage));
            if (DeviceProperties.isWearable(context)) {
                Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
                a2.a(context.getApplicationInfo().icon).d(2);
                ...
                a2.a(17301642).e((CharSequence) resources.getString(R.string.common_google_play_services_notification_ticker)).a(System.currentTimeMillis()).a(pendingIntent).b((CharSequence) errorNotificationMessage);
            }
            if (PlatformVersion.isAtLeastO()) {
