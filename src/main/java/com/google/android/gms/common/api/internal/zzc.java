...
public final class zzc extends Fragment implements LifecycleFragment {
    private static WeakHashMap<c, WeakReference<zzc>> zzbe = new WeakHashMap<>();
    ...
    public static zzc zza(c cVar) {
        WeakReference weakReference = zzbe.get(cVar);
        ...
        try {
            zzc zzc2 = (zzc) cVar.getSupportFragmentManager().a("SupportLifecycleFragmentImpl");
            if (zzc2 == null || zzc2.isRemoving()) {
                zzc2 = new zzc();
                cVar.getSupportFragmentManager().a().a((Fragment) zzc2, "SupportLifecycleFragmentImpl").c();
            }
            zzbe.put(cVar, new WeakReference(zzc2));
            return zzc2;
