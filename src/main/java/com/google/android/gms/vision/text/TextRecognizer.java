    ...
    public final SparseArray<TextBlock> detect(Frame frame) {
        ...
        if (frame != null) {
            ...
            if (!zzz.zzdr.isEmpty()) {
                ...
                int i3 = zzc.rotation;
                zzz.zzdr.set(i3 != 1 ? i3 != 2 ? i3 != 3 ? rect : new Rect(rect.top, width - rect.right, rect.bottom, width - rect.left) : new Rect(width - rect.right, height - rect.bottom, width - rect.left, height - rect.top) : new Rect(height - rect.bottom, rect.left, height - rect.top, rect.right));
            }
            zzc.rotation = 0;
