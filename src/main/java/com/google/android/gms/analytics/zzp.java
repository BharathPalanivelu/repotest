...
final class zzp implements Runnable {
    ...
    public final void run() {
        if (this.zztp.zztf.zzax()) {
            this.zzti.put("sc", ViewProps.START);
        }
        Map map = this.zzti;
        ...
        zzcz.zzb((Map<String, String>) this.zzti, AppsFlyerLibCore.ATTRIBUTION_ID_COLUMN_NAME, zzdv.zzbb());
        ...
        if ((this.zztk.equals("transaction") || this.zztk.equals("item")) || this.zztp.zzte.zzfm()) {
            ...
            zzcz.zza((Map<String, String>) hashMap, AppsFlyerLibCore.ATTRIBUTION_ID_COLUMN_NAME, (Map<String, String>) this.zzti);
