...
public final class zzai extends AbstractSafeParcelable implements Place.ExtendedDetails {
    ...
    zzai(@SafeParcelable.Param(id = 1) List<Integer> list, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) Uri uri, @SafeParcelable.Param(id = 4) float f2, @SafeParcelable.Param(id = 5) int i) {
