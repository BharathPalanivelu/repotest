...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    LocationRequest(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) long j, @SafeParcelable.Param(id = 3) long j2, @SafeParcelable.Param(id = 4) boolean z, @SafeParcelable.Param(id = 5) long j3, @SafeParcelable.Param(id = 6) int i2, @SafeParcelable.Param(id = 7) float f2, @SafeParcelable.Param(id = 8) long j4) {
        this.priority = i;
        this.zzaw = j;
        this.zzax = j2;
        this.zzay = z;
    ...
    public final LocationRequest setInterval(long j) {
        ...
        this.zzaw = j;
        if (!this.zzay) {
            double d2 = (double) this.zzaw;
            Double.isNaN(d2);
            this.zzax = (long) (d2 / 6.0d);
        }
        return this;
    }
