...
class zzjk<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public boolean containsKey(Object obj) {
        ...
        return zza(comparable) >= 0 || this.zzwu.containsKey(comparable);
    }
    ...
    public V get(Object obj) {
        ...
        if (zza >= 0) {
            return this.zzwt.get(zza).getValue();
        }
    ...
    public final V put(K k, V v) {
        ...
        int zza = zza(k);
        if (zza >= 0) {
            return this.zzwt.get(zza).setValue(v);
        }
        zziu();
        ...
        if (size == i2) {
            ...
            zziv().put((Comparable) remove.getKey(), remove.getValue());
        }
    ...
    public final V zzbn(int i) {
        zziu();
        V value = this.zzwt.remove(i).getValue();
        if (!this.zzwu.isEmpty()) {
            Iterator it = zziv().entrySet().iterator();
            this.zzwt.add(new zzjp(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zzwv == null) {
            this.zzwv = new zzjr(this, (zzjj) null);
        }
        return this.zzwv;
    }
    ...
    public final Set<Map.Entry<K, V>> zzit() {
        if (this.zzwx == null) {
            this.zzwx = new zzjl(this, (zzjj) null);
        }
        return this.zzwx;
    }
