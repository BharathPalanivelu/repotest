...
final class zzcj<FieldDescriptorType extends zzcl<FieldDescriptorType>> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:5:0x001b, code lost:
        if ((r3 instanceof com.google.android.gms.internal.vision.zzda) == false) goto L_0x0043;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0024, code lost:
        if ((r3 instanceof com.google.android.gms.internal.vision.zzcu) == false) goto L_0x0043;
     */
    ...
    private static int zzd(Map.Entry<FieldDescriptorType, Object> entry) {
        zzcl zzcl = (zzcl) entry.getKey();
        Object value = entry.getValue();
        return (zzcl.zzbp() != zzfy.MESSAGE || zzcl.zzbq() || zzcl.zzbr()) ? zzb((zzcl<?>) zzcl, value) : value instanceof zzda ? zzca.zzb(((zzcl) entry.getKey()).zzbn(), (zzde) (zzda) value) : zzca.zzb(((zzcl) entry.getKey()).zzbn(), (zzdx) value);
    }
