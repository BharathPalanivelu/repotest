    ...
    static final class zzd extends zzee {
        ...
        public final void zzbf(int i) throws IOException {
            ...
            while (true) {
                long j3 = this.zzaen;
                if (j3 >= this.zzael) {
                    throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j3), Long.valueOf(this.zzael), 1}));
                } else if ((i & -128) == 0) {
                    this.zzaen = 1 + j3;
                    zzhv.zza(j3, (byte) i);
                    return;
        ...
        public final void zzbn(long j) throws IOException {
            ...
            while (true) {
                long j4 = this.zzaen;
                if (j4 >= this.zzael) {
                    throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Long.valueOf(j4), Long.valueOf(this.zzael), 1}));
                } else if ((j & -128) == 0) {
                    this.zzaen = 1 + j4;
