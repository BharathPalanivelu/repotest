...
public final class zzw extends zzby {
    ...
    private static void zza(Logger logger, StringBuilder sb, StringBuilder sb2, zzaj zzaj, String str, Object obj, Writer writer) throws IOException {
        if (obj != null && !zzbt.isNull(obj)) {
            String name = obj instanceof Enum ? zzbz.zza((Enum<?>) (Enum) obj).getName() : obj.toString();
            String str2 = ((HttpConstants.Header.AUTHORIZATION.equalsIgnoreCase(str) || "Cookie".equalsIgnoreCase(str)) && (logger == null || !logger.isLoggable(Level.ALL))) ? "<Not Logged>" : name;
            if (sb != null) {
                sb.append(str);
                sb.append(": ");
                sb.append(str2);
    ...
    static void zza(zzw zzw, StringBuilder sb, StringBuilder sb2, Logger logger, zzaj zzaj) throws IOException {
        ...
        for (Map.Entry next : zzw.entrySet()) {
                ...
                if (value != null) {
                    ...
                    if ((value instanceof Iterable) || cls.isArray()) {
                        for (Object zza : zzco.zzi(value)) {
                            zza(logger, sb, sb2, zzaj, str, zza, (Writer) null);
                        }
                    } else {
                        zza(logger, sb, sb2, zzaj, str, value, (Writer) null);
                    }
                }
            } else {
