...
final class zzay extends zzan implements Closeable {
    ...
    private final List<Long> zzc(long j) {
        ...
        Cursor cursor = null;
        try {
            Cursor query = writableDatabase.query("hits2", new String[]{"hit_id"}, (String) null, (String[]) null, (String) null, (String) null, String.format("%s ASC", new Object[]{"hit_id"}), Long.toString(j));
            ...
            zzd("Error selecting hit ids", e2);
            if (cursor != null) {
                cursor.close();
            }
        } catch (Throwable th) {
