...
public final class zzbs {
    ...
    public static final class zza extends zzey<zza, C0212zza> implements zzgk {
        ...
        public static final class C0212zza extends zzey.zza<zza, C0212zza> implements zzgk {
            private C0212zza() {
                super(zza.zzwf);
            }

            public final C0212zza zzi(int i) {
                zzuc();
            ...
            public final C0212zza zza(zzi.zza zza) {
                zzuc();
            ...
            public final C0212zza zza(zzi zzi) {
                zzuc();
                ((zza) this.zzahx).zzb(zzi);
                return this;
            }

            public final C0212zza zzk(boolean z) {
                zzuc();
                ((zza) this.zzahx).zzl(z);
                return this;
            }

            /* synthetic */ C0212zza(zzbr zzbr) {
                this();
            }
        }
        ...
        public static C0212zza zzmc() {
            return (C0212zza) zzwf.zzui();
        }
    ...
    public static final class zzg extends zzey<zzg, zza> implements zzgk {
        ...
        public final boolean zzoq() {
            return (this.zzue & TIMGroupManager.TIM_GET_GROUP_BASE_INFO_FLAG_GROUP_TYPE) != 0;
        }
        ...
        public final void zzh(long j) {
            this.zzue |= TIMGroupManager.TIM_GET_GROUP_BASE_INFO_FLAG_GROUP_TYPE;
            this.zzxo = j;
        }

        public final boolean zzor() {
            return (this.zzue & TIMGroupManager.TIM_GET_GROUP_BASE_INFO_FLAG_LAST_MSG) != 0;
        }
        ...
        public final void zzbe(long j) {
            this.zzue |= TIMGroupManager.TIM_GET_GROUP_BASE_INFO_FLAG_LAST_MSG;
            this.zzxp = j;
        }
        ...
        public final void zzcw(String str) {
            if (str != null) {
                this.zzue |= NativeProtocol.MESSAGE_GET_ACCESS_TOKEN_REQUEST;
                this.zzxq = str;
                return;
            }
            throw new NullPointerException();
        ...
        public final boolean zzox() {
            return (this.zzue & ByteConstants.MB) != 0;
        }
        ...
        public final void zzcz(String str) {
            if (str != null) {
                this.zzue |= RNCartPanelDataEntity.NULL_VALUE;
                this.zzyg = str;
                return;
            }
            throw new NullPointerException();
    ...
    public static final class zzk extends zzey<zzk, zza> implements zzgk {
        ...
        public static final class zza extends zzey.zza<zzk, zza> implements zzgk {
            ...
            public final zza zzc(double d2) {
                zzuc();
                ((zzk) this.zzahx).zzb(d2);
                return this;
            }
