...
public final class zzam implements zzci {
    public static final String MEDIA_TYPE = new zzy(HttpConstants.ContentType.X_WWW_FORM_URLENCODED).zza(zzbo.UTF_8).zzp();
                        ...
                        if (zzai.length() != 0) {
                            ...
                            if (zzae != null) {
                                ...
                                if (zzco.zzc(zza)) {
                                    ...
                                    zzbn.zza(zzae.zzbz(), zzb, zza((Type) zzb, (List<Type>) asList, zzai2));
                                } else if (zzco.zza(zzco.zzb(asList, zza), (Class<?>) Iterable.class)) {
                                    Collection<Object> collection = (Collection) zzae.zzh(obj2);
                                    if (collection == null) {
                                        collection = zzbt.zzb(zza);
                                        zzae.zzb(obj2, collection);
                                    }
                                    collection.add(zza(zza == Object.class ? null : zzco.zze(zza), (List<Type>) asList, zzai2));
                                } else {
                                    zzae.zzb(obj2, zza(zza, (List<Type>) asList, zzai2));
                                }
                            } else if (map != null) {
