...
public abstract class zzaj extends zzt {
    ...
    public final void zzb(int i, double d2) throws IOException {
        zzd(i, Double.doubleToRawLongBits(d2));
    }
    ...
    static class zzb extends zzaj {
        ...
        public final void zzd(byte b2) throws IOException {
            try {
                ...
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), 1}), e2);
            }
        }
        ...
        private final void write(byte[] bArr, int i, int i2) throws IOException {
            try {
                ...
                throw new zzc(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.position), Integer.valueOf(this.limit), Integer.valueOf(i2)}), e2);
            }
        }
        ...
        public final void zzj(String str) throws IOException {
            ...
            try {
                ...
                if (zzt2 == zzt) {
                    ...
                    int zzb = zzea.zzb(str, this.buffer, this.position, zzak());
                    this.position = i;
                    zzo((zzb - i) - zzt2);
                    this.position = zzb;
                    return;
