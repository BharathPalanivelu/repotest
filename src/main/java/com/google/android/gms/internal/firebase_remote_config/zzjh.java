...
final class zzjh {
    ...
    static int zzs(List<Long> list) {
        ...
        if (list instanceof zzie) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzi(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzt(List<Long> list) {
        ...
        if (list instanceof zzie) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzj(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzu(List<Long> list) {
        ...
        if (list instanceof zzie) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzk(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzv(List<Integer> list) {
        ...
        if (list instanceof zzhk) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzaw(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzhk) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzar(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzx(List<Integer> list) {
        ...
        if (list instanceof zzhk) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzas(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzy(List<Integer> list) {
        ...
        if (list instanceof zzhk) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzgs.zzat(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzd(int i, List<zziq> list, zzjf zzjf) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzgs.zzc(i, list.get(i3), zzjf);
        }
        return i2;
    }
