...
final class zzed extends zzec {
    ...
    public final int zzc(int r16, byte[] r17, int r18, int r19) {
        ...
        L_0x0050:
            ...
            long r13 = r11 + r9
            byte r1 = com.google.android.gms.internal.places.zzdy.zzb(r0, r11)
        ...
        L_0x0062:
            ...
            int r0 = zzb(r0, r1, r11, r2)
            return r0
        L_0x006d:
            int r2 = r2 + -2
            long r13 = r11 + r9
            byte r11 = com.google.android.gms.internal.places.zzdy.zzb(r0, r11)
        ...
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                ...
                if (zzdz.zze(zzb2)) {
                    ...
                    int i12 = i11 + 1;
                    zzdz.zzb(zzb2, zzb4, zzdy.zzb(bArr, (long) i11), zzdy.zzb(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzbk.zzbu();
    ...
    public final int zzc(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            zzdy.zzb(bArr2, j4, (byte) charAt2);
            i5++;
            j4 = 1 + j4;
        }
        if (i5 == length) {
        ...
        while (i5 < length) {
            ...
            if (charAt3 < c2 && j4 < j5) {
                long j6 = j4 + j;
                zzdy.zzb(bArr2, j4, (byte) charAt3);
                j3 = j;
                j2 = j6;
            } else if (charAt3 < 2048 && j4 <= j5 - 2) {
                long j7 = j4 + j;
                zzdy.zzb(bArr2, j4, (byte) ((charAt3 >>> 6) | TXEAudioDef.TXE_OPUS_SAMPLE_NUM));
                zzdy.zzb(bArr2, j7, (byte) ((charAt3 & '?') | 128));
                j2 = j7 + j;
                j3 = j;
                i5++;
                c2 = 128;
                ...
                long j9 = j4 + j;
                zzdy.zzb(bArr2, j4, (byte) ((charAt3 >>> 12) | 480));
                long j10 = j9 + j;
                zzdy.zzb(bArr2, j9, (byte) (((charAt3 >>> 6) & 63) | 128));
                zzdy.zzb(bArr2, j10, (byte) ((charAt3 & '?') | 128));
                j2 = j10 + 1;
                j3 = 1;
            } else if (j4 <= j5 - 4) {
                int i6 = i5 + 1;
                if (i6 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j11 = j4 + 1;
                        zzdy.zzb(bArr2, j4, (byte) ((codePoint >>> 18) | 240));
                        long j12 = j11 + 1;
                        zzdy.zzb(bArr2, j11, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j13 = j12 + 1;
                        zzdy.zzb(bArr2, j12, (byte) (((codePoint >>> 6) & 63) | 128));
                        j3 = 1;
                        j2 = j13 + 1;
                        zzdy.zzb(bArr2, j13, (byte) ((codePoint & 63) | 128));
                        i5 = i6;
                        i5++;
                        c2 = 128;
                        long j82 = j3;
