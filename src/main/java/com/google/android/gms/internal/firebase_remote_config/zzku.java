...
interface zzku {
    ...
    void zza(int i, zzfx zzfx) throws IOException;

    <K, V> void zza(int i, zzih<K, V> zzih, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjf zzjf) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjf zzjf) throws IOException;

    void zza(int i, List<Integer> list, boolean z) throws IOException;

    @Deprecated
    void zzaz(int i) throws IOException;

    void zzb(int i, long j) throws IOException;

    @Deprecated
    void zzb(int i, Object obj, zzjf zzjf) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzfx> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjf zzjf) throws IOException;
