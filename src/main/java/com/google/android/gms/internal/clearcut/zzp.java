...
public final class zzp implements ClearcutLogger.zza {
    ...
    private static boolean zzb(long j, long j2, long j3) {
        ...
        return ((j > 0 ? 1 : (j == 0 ? 0 : -1)) >= 0 ? j % j3 : (((Clock.MAX_TIME % j3) + 1) + ((j & Clock.MAX_TIME) % j3)) % j3) < j2;
    }
    ...
    public final boolean zza(zze zze) {
        ...
        if (this.zzh == null) {
            ...
            if (zzae2 == null) {
                ...
                zzae putIfAbsent = zzas.putIfAbsent(str, zzae2);
                if (putIfAbsent != null) {
                    zzae2 = putIfAbsent;
                }
            }
