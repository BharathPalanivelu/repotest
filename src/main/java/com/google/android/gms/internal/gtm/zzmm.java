...
public final class zzmm {
    static zznm zzcd(String str) throws JSONException, zzml {
        ...
        if (obj instanceof JSONObject) {
            ...
            zznn zznn = new zznn();
            zznn.zzcl(jSONObject.optString(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION));
    ...
    private static zznz zza(Object obj, List<String> list) throws zzml, JSONException {
        ...
        if (obj instanceof JSONArray) {
            ...
            if (string.equals("escape")) {
                zznz = zza(jSONArray.get(1), list);
                for (int i = 2; i < jSONArray.length(); i++) {
                    zznz.zzab(jSONArray.getInt(i));
                }
                ...
                zznz zznz2 = new zznz(2, arrayList);
                zznz2.zzh(true);
                return zznz2;
                ...
                zznz zznz3 = new zznz(3, hashMap);
                zznz3.zzh(true);
                return zznz3;
            } else if (string.equals("macro")) {
                zznz = new zznz(4, list.get(jSONArray.getInt(1)));
                zznz.zzh(true);
                ...
                zznz zznz4 = new zznz(7, arrayList2);
                zznz4.zzh(true);
                return zznz4;
            } else {
            ...
            return new zznz(8, obj);
        } else {
            if (obj instanceof Integer) {
                return new zznz(6, obj);
            }
            if (obj instanceof String) {
                return new zznz(1, obj);
            }
    ...
    static zznu zzce(String str) throws JSONException, zzml {
        ...
        if (obj instanceof JSONObject) {
            zznw.zzcm(((JSONObject) obj).optString(ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION));
