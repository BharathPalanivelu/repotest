    ...
    public final synchronized void close() throws IOException {
        if (!this.closed) {
            if (this.zzgb != 0) {
                ...
                if (this.count != 0) {
                    this.logger.logp(this.zzgd, "com.google.api.client.util.LoggingByteArrayOutputStream", "close", toString("UTF-8").replaceAll("[\\x00-\\x09\\x0B\\x0C\\x0E-\\x1F\\x7F]", SQLBuilder.BLANK));
                }
            }
            this.closed = true;
        }
