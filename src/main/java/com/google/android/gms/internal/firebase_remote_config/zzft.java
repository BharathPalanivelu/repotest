...
final class zzft {
    static int zza(byte[] bArr, int i, zzfw zzfw) {
        ...
        byte b2 = bArr[i];
        if (b2 < 0) {
            return zza((int) b2, bArr, i2, zzfw);
        }
        zzfw.zzor = b2;
        return i2;
    }
    ...
    static int zza(com.google.android.gms.internal.firebase_remote_config.zzjf r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.firebase_remote_config.zzfw r10) throws java.io.IOException {
        /*
            ...
            int r0 = zza((int) r8, (byte[]) r7, (int) r0, (com.google.android.gms.internal.firebase_remote_config.zzfw) r10)
            int r8 = r10.zzor
        L_0x000c:
            r3 = r0
        ...
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                ...
                while (true) {
                    ...
                    i7 = i8;
                    i2 = zza(i8, bArr, zza2, i3, zzjb, zzfw);
                }
                if (i2 > i3 || i7 != i6) {
                    throw zzhq.zzhl();
                }
