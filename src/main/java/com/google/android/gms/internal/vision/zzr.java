...
public final class zzr extends AbstractSafeParcelable {
    ...
    public zzr(@SafeParcelable.Param(id = 2) int i, @SafeParcelable.Param(id = 3) int i2, @SafeParcelable.Param(id = 4) int i3, @SafeParcelable.Param(id = 5) int i4, @SafeParcelable.Param(id = 6) float f2) {
        this.left = i;
        this.top = i2;
        this.width = i3;
        this.height = i4;
