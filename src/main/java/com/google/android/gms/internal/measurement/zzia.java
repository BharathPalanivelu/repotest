...
final class zzia {
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b2, byte b3, char[] cArr, int i) throws zzfi {
        if (b2 < -62 || zzg(b3)) {
            throw zzfi.zzvb();
        }
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b2, byte b3, byte b4, char[] cArr, int i) throws zzfi {
    ...
    /* access modifiers changed from: private */
    public static void zza(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i) throws zzfi {
