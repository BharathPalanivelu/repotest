...
final class zzck extends zzan {
    ...
    public final java.util.List<java.lang.Long> zzb(java.util.List<com.google.android.gms.internal.gtm.zzcd> r9) {
        ...
        L_0x00b8:
            ...
            int r9 = r8.zzb((java.net.URL) r9, (byte[]) r0)
            goto L_0x00cb
        L_0x00c3:
            byte[] r0 = r1.getPayload()
            int r9 = r8.zza((java.net.URL) r9, (byte[]) r0)
        L_0x00cb:
    ...
    private final int zza(java.net.URL r5, byte[] r6) {
        ...
        L_0x0022:
            ...
            r4.zza((java.net.HttpURLConnection) r5)     // Catch:{ IOException -> 0x006b }
    ...
    private final int zzb(java.net.URL r11, byte[] r12) {
        ...
        L_0x0073:
            ...
            r10.zza((java.net.HttpURLConnection) r11)     // Catch:{ IOException -> 0x00c5, all -> 0x00c0 }
    ...
    private final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (openConnection instanceof HttpURLConnection) {
            ...
            httpURLConnection.setRequestProperty(HttpConstants.Header.USER_AGENT, this.zzabp);
