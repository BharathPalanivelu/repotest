...
final class zzha<FieldDescriptorType extends zzhc<FieldDescriptorType>> {
    ...
    private final void zza(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        this.zzqf.put(fielddescriptortype, obj);
    }
    ...
    public final boolean isInitialized() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzb : this.zzqf.zzis()) {
            if (!zzb(zzb)) {
                return false;
            }
        }
    ...
    public final void zza(zzha<FieldDescriptorType> zzha) {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzc : zzha.zzqf.zzis()) {
            zzc(zzc);
        }
    }
    ...
    public final int zzgj() {
        ...
        for (Map.Entry<FieldDescriptorType, Object> zzd : this.zzqf.zzis()) {
            i += zzd(zzd);
        }
        return i;
    }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        ...
        for (int i = 0; i < this.zzqf.zzir(); i++) {
            ...
            zzha.zza((zzhc) zzbm.getKey(), zzbm.getValue());
        }
        for (Map.Entry next : this.zzqf.zzis()) {
            zzha.zza((zzhc) next.getKey(), next.getValue());
        }
        zzha.zzqh = this.zzqh;
        return zzha;
    }
