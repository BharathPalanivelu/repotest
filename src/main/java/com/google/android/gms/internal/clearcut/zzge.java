...
public final class zzge {
    ...
    public static final class zza extends zzcg<zza, C0198zza> implements zzdq {
        ...
        public static final class C0198zza extends zzcg.zza<zza, C0198zza> implements zzdq {
            private C0198zza() {
                super(zza.zzsm);
            }

            /* synthetic */ C0198zza(zzgf zzgf) {
                this();
            }
        }
    ...
    public static final class zzq extends zzcg.zzd<zzq, zza> implements zzdq {
        ...
        public enum zzb implements zzcj {
            ...
            SOCIAL_AFFINITY_GMAIL(im_common.MSG_PUSH),
            SOCIAL_AFFINITY_INBOX(im_common.GRP_PUBGROUP),
            ...
            GOOGLE_EXPRESS_ANDROID_PRIMES(TLSErrInfo.LOGIN_NO_ACCOUNT),
            ...
            GEARHEAD_ANDROID_PRIMES(DanmaKuEntity.MESSAGE_PUBLIC),
            ...
            CLOUDDPC_PRIMES(304),
            CLOUDDPC_ARC_PRIMES(im_common.NEARBY_PEOPLE_TMP_OWN_MSG),
            ICORE(137),
            ...
            CRONET_FIREBALL(im_common.RICH_STATUS_TMP_MSG),
            FIREBALL_PRIMES(266),
            ...
            MYFIBER(194),
            RECORDED_PAGES(195),
            MOB_DOG(BuildConfig.VERSION_CODE),
            WALLET_APP(198),
            GBOARD(199),
            CRONET_GMM(203),
            TRUSTED_FACE(http.No_Content),
            MATCHSTICK(205),
            MATCHSTICK_COUNTERS(372),
            APP_CATALOG(http.Partial_Content),
            ...
            BEACON_GCORE(301),
            ANDROID_STUDIO(302),
            DOCS_OFFLINE(im_common.BUSINESS_MB_WPA_C2C_TMP_MSG),
            FREIGHTER(307),
            DOCS_IOS_PRIMES(308),
            SLIDES_IOS_PRIMES(im_common.QQ_SEARCH_TMP_C2C_MSG),
            SHEETS_IOS_PRIMES(im_common.NEARBY_PEOPLE_TMP_DATE_MSG),
            IPCONNECTIVITY(311),
            CURATOR(312),
            ...
            PAISA_MERCHANT_ANDROID_PRIMES(cn.tongdun.android.BuildConfig.VERSION_CODE),
            ...
            PHOTOS_SCANNER(HttpResponseCode.NOT_ACCEPTABLE),
            BG_IN_OGB(407),
            BLOGGER(http.Request_Timeout),
            CORP_IOS_FOOD(409),
            BEACON_GCORE_TEST(410),
            LINKS_IOS_PRIMES(411),
            CHAUFFEUR(FacebookRequestErrorClassification.EC_APP_NOT_INSTALLED),
            SNAPSEED(http.Request_Entity_Too_Large),
            EARTH_ANDROID_PRIMES(http.Request_URI_Too_Long),
            CORP_ANDROID_AIUTO(415),
            GFTV_MOBILE_PRIMES(http.Requested_Range_Not_Satisfiable),
            GMAIL_IOS(417),
            TOPAZ_ANDROID_PRIMES(418),
            SOCIAL_COUNTERS(HttpResponseCode.ENHANCE_YOUR_CLAIM),
            CORP_ANDROID_MOMA(421),
            MEETINGS_LOG_REQUEST(HttpResponseCode.UNPROCESSABLE_ENTITY),
            GDEAL(423),
            GOOGLETTS(424),
            ...
            CORP_ANDROID_GBUS(HttpResponseCode.TOO_MANY_REQUESTS),
            ...
            ACTIVITY_RECOGNITION(im_common.GRP_CONFERENCE),
            VR_STREAMING_COUNTERS(im_common.GRP_HRTX),
            TOPAZ_IOS_PRIMES(517),
            NEWS_EVENT(518),
            CHROMOTING(519),
            CHROMOTING_COUNTERS(im_common.BU_FRIEND),
            ...
            TURBO(599),
            ANDROID_OTA(IjkMediaCodecInfo.RANK_LAST_CHANCE),
            ...
            ARCORE(700),
            GOOGLE_WIFI_ANDROID_PRIMES(IMediaPlayer.MEDIA_INFO_BUFFERING_START),
            PROXIMITY_AUTH_COUNTERS(IMediaPlayer.MEDIA_INFO_BUFFERING_END),
            ...
            HATS(749),
            HATS_STAGING(IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE),
            ...
            STREAMZ_ANDROID_BUILD(IMediaPlayer.MEDIA_INFO_METADATA_UPDATE),
            ...
            public static zzb zzax(int i) {
                switch (i) {
                    ...
                    case cn.tongdun.android.BuildConfig.VERSION_CODE:
