...
interface zzgw {
    ...
    void zza(int i, zzcl zzcl) throws IOException;

    <K, V> void zza(int i, zzeo<K, V> zzeo, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzfk zzfk) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzfk zzfk) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzfk zzfk) throws IOException;

    void zzb(int i, List<zzcl> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzfk zzfk) throws IOException;
