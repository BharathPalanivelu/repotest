...
public abstract class zzfx implements Serializable, Iterable<Byte> {
    ...
    private static final zzgd zzow = (zzfu.zzeu() ? new zzgk((zzga) null) : new zzgb((zzga) null));
    private static final Comparator<zzfx> zzox = new zzfz();
    private int zziy = 0;
