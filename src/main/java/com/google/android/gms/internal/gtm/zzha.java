...
public final class zzha {
    ...
    public static String zzd(zzoa<?> zzoa) {
        ...
        if (zzoa instanceof zzoe) {
            String d2 = Double.toString(((Double) ((zzoe) zzoa).value()).doubleValue());
            ...
            if (zzf(zzoa)) {
                ...
                if (zze.equals(zze2)) {
                    ...
                    if (c2 == 2) {
                        ...
                        return c2 != 4 ? c2 == 5 && zzoa == zzoa2 : ((Boolean) ((zzod) zzoa).value()) == ((Boolean) ((zzod) zzoa2).value());
                    } else {
    ...
    public static boolean zzd(zzoa<?> zzoa, zzoa<?> zzoa2) {
        ...
        if (zzf(zzoa)) {
            ...
            if (c2 != 2) {
                return c2 != 3 ? c2 != 4 ? zzoa == zzoa2 : ((Boolean) ((zzod) zzoa).value()) == ((Boolean) ((zzod) zzoa2).value()) : ((String) ((zzom) zzoa).value()).equals((String) ((zzom) zzoa2).value());
            }
            double doubleValue = ((Double) ((zzoe) zzoa).value()).doubleValue();
            double doubleValue2 = ((Double) ((zzoe) zzoa2).value()).doubleValue();
            return !Double.isNaN(doubleValue) && !Double.isNaN(doubleValue2) && doubleValue == doubleValue2;
