...
public class Cap extends AbstractSafeParcelable {
    ...
    private Cap(int i, BitmapDescriptor bitmapDescriptor2, Float f2) {
        Preconditions.checkArgument(i != 3 || (bitmapDescriptor2 != null && (f2 != null && (f2.floatValue() > BitmapDescriptorFactory.HUE_RED ? 1 : (f2.floatValue() == BitmapDescriptorFactory.HUE_RED ? 0 : -1)) > 0)), String.format("Invalid Cap: type=%s bitmapDescriptor=%s bitmapRefWidth=%s", new Object[]{Integer.valueOf(i), bitmapDescriptor2, f2}));
        this.type = i;
    ...
    protected Cap(BitmapDescriptor bitmapDescriptor2, float f2) {
        this(3, bitmapDescriptor2, Float.valueOf(f2));
    }
