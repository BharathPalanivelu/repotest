...
public final class zzak {
    ...
    static {
        ...
        zzgm = zza("measurement.upload.max_batch_size", valueOf, valueOf, zzar.zzji);
        zzgn = zza("measurement.upload.max_bundle_size", valueOf, valueOf, zzaq.zzji);
        Long valueOf2 = Long.valueOf(Timer.DEFAULT_TIMER_DELAY_MS);
