...
public final class zzs extends zzgf {
    ...
    private final Bundle zzbo() {
        try {
            ...
            zzab().zzgk().zza("Failed to load metadata: Package name not found", e2);
            return null;
        }
    }
    ...
    public final String zzbu() {
        try {
            ...
            zzab().zzgk().zza("Could not find SystemProperties class", e2);
            return "";
        } catch (NoSuchMethodException e3) {
            zzab().zzgk().zza("Could not find SystemProperties.get() method", e3);
            return "";
        } catch (IllegalAccessException e4) {
            zzab().zzgk().zza("Could not access SystemProperties.get()", e4);
            return "";
        } catch (InvocationTargetException e5) {
            zzab().zzgk().zza("SystemProperties.get() threw an exception", e5);
            return "";
        }
    }
