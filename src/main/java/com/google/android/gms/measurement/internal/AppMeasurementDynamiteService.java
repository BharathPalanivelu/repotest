...
public class AppMeasurementDynamiteService extends zzn {
    ...
    public void setUserId(String str, long j) throws RemoteException {
        zzbi();
        this.zzj.zzq().zza((String) null, FieldType.FOREIGN_ID_FIELD_SUFFIX, str, true, j);
    }
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, zzp zzp, long j) throws RemoteException {
        ...
        (bundle != null ? new Bundle(bundle) : new Bundle()).putString("_o", LiveParams.SYNC_TYPE_APP);
        this.zzj.zzaa().zza((Runnable) new zzj(this, zzp, new zzai(str2, new zzah(bundle), LiveParams.SYNC_TYPE_APP, j), str));
    }
