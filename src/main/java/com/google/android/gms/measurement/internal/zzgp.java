...
public final class zzgp extends zzg {
    ...
    public final Boolean zzig() {
        ...
        return (Boolean) zzaa().zza(atomicReference, Timer.DEFAULT_TIMER_DELAY_MS, "boolean test flag value", new zzgo(this, atomicReference));
    }

    public final String zzih() {
        AtomicReference atomicReference = new AtomicReference();
        return (String) zzaa().zza(atomicReference, Timer.DEFAULT_TIMER_DELAY_MS, "String test flag value", new zzgy(this, atomicReference));
    }

    public final Long zzii() {
        AtomicReference atomicReference = new AtomicReference();
        return (Long) zzaa().zza(atomicReference, Timer.DEFAULT_TIMER_DELAY_MS, "long test flag value", new zzha(this, atomicReference));
    }

    public final Integer zzij() {
        AtomicReference atomicReference = new AtomicReference();
        return (Integer) zzaa().zza(atomicReference, Timer.DEFAULT_TIMER_DELAY_MS, "int test flag value", new zzhd(this, atomicReference));
    }

    public final Double zzik() {
        AtomicReference atomicReference = new AtomicReference();
        return (Double) zzaa().zza(atomicReference, Timer.DEFAULT_TIMER_DELAY_MS, "double test flag value", new zzhc(this, atomicReference));
    }
        ...
        if (zzad().zze(zzr().zzag(), zzak.zzik)) {
            ...
            if (zzho != null) {
                if ("unset".equals(zzho)) {
                    zza(LiveParams.SYNC_TYPE_APP, "_npa", (Object) null, zzx().currentTimeMillis());
                } else {
                    zza(LiveParams.SYNC_TYPE_APP, "_npa", (Object) Long.valueOf(ServerProtocol.DIALOG_RETURN_SCOPES_TRUE.equals(zzho) ? 1 : 0), zzx().currentTimeMillis());
                }
            }
        }
    ...
    public final void zza(java.lang.String r28, java.lang.String r29, long r30, android.os.Bundle r32, boolean r33, boolean r34, boolean r35, java.lang.String r36) {
        ...
        L_0x0134:
            ...
            r1.zzz()
            java.lang.String r0 = com.google.android.gms.measurement.internal.zzjs.zza((java.lang.String) r15, (int) r0, (boolean) r9)
        ...
        L_0x0187:
            r4 = 0
        L_0x0188:
            com.google.android.gms.measurement.internal.zzhq.zza((com.google.android.gms.measurement.internal.zzhr) r2, (android.os.Bundle) r12, (boolean) r4)
        ...
        L_0x0279:
            ...
            r3.zzb((android.os.Bundle) r15, (long) r1)
        L_0x02af:
        ...
        L_0x03d6:
            ...
            r2 = r8[r1]
            r5 = 1
            com.google.android.gms.measurement.internal.zzhq.zza((com.google.android.gms.measurement.internal.zzhr) r14, (android.os.Bundle) r2, (boolean) r5)
    ...
    public final void logEvent(String str, String str2, Bundle bundle, boolean z, boolean z2, long j) {
        boolean z3;
        zzm();
        String str3 = str == null ? LiveParams.SYNC_TYPE_APP : str;
        ...
        if (zzaa().zzhp()) {
            ...
            synchronized (atomicReference) {
                ...
                try {
                    ...
                    zzab().zzgn().zza("Interrupted waiting for get user properties", e2);
                }
            }
    ...
    public final void zze(Bundle bundle) {
        ...
        zzjn zzjn = new zzjn(bundle2.getString("name"), bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_TIMESTAMP), bundle2.get(AppMeasurementSdk.ConditionalUserProperty.VALUE), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN));
        try {
            zzai zza = zzz().zza(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME), bundle2.getBundle(AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), 0, true, false);
            zzs().zzd(new zzq(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), zzjn, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP), false, bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME), zzz().zza(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME), bundle2.getBundle(AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), 0, true, false), bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT), zza, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE), zzz().zza(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME), bundle2.getBundle(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), 0, true, false)));
    ...
    public final void zzf(Bundle bundle) {
        ...
        try {
            zzai zza = zzz().zza(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME), bundle2.getBundle(AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP), true, false);
            zzjn zzjn2 = zzjn;
            zzs().zzd(new zzq(bundle2.getString("app_id"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN), zzjn2, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP), bundle2.getBoolean("active"), bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME), (zzai) null, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT), (zzai) null, bundle2.getLong(AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE), zza));
        } catch (IllegalArgumentException unused) {
        }
    }
        ...
        if (zzaa().zzhp()) {
            ...
            synchronized (atomicReference) {
                ...
                try {
                    ...
                    zzab().zzgn().zza("Interrupted waiting for get conditional user properties", str, e2);
                }
            }
    ...
    private final Map<String, Object> zzb(String str, String str2, String str3, boolean z) {
        if (zzaa().zzhp()) {
            ...
            for (zzjn zzjn : list) {
                aVar.put(zzjn.name, zzjn.getValue());
            }
            return aVar;
        }
    }
    ...
    public final String getGmpAppId() {
        ...
        try {
            ...
            this.zzj.zzab().zzgk().zza("getGoogleAppId failed with exception", e2);
            return null;
        }
    }
