...
public final class zzjs extends zzge {
    ...
    private static final List<String> zzua = Collections.unmodifiableList(Arrays.asList(new String[]{ShareConstants.FEED_SOURCE_PARAM, "medium", "campaign", "term", UriUtil.LOCAL_CONTENT_SCHEME}));
    private int zzag;
    ...
    public final Bundle zza(Uri uri) {
        ...
        try {
            ...
            zzab().zzgn().zza("Install referrer url isn't a hierarchical URI", e2);
            return null;
        }
    }
    ...
    public final int zzbl(String str) {
        if (!zzq(EventRepository.TABLE, str)) {
            return 2;
        }
        if (!zza(EventRepository.TABLE, zzgj.zzpn, str)) {
            return 13;
        }
        if (!zza(EventRepository.TABLE, 40, str)) {
            return 2;
        }
        return 0;
    }
    ...
    public final android.os.Bundle zza(java.lang.String r17, java.lang.String r18, android.os.Bundle r19, java.util.List<java.lang.String> r20, boolean r21, boolean r22) {
        /*
            r16 = this;
            r6 = r16
            r7 = r17
    ...
    private final boolean zzd(Context context, String str) {
        ...
        try {
            ...
            zzab().zzgk().zza("Package name not found", e3);
            return true;
        }
    }
    ...
    public final void zzb(zzp zzp, String str) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning string value to wrapper", e2);
        }
    }
    ...
    public final void zza(zzp zzp, long j) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning long value to wrapper", e2);
        }
    }
    ...
    public final void zza(zzp zzp, int i) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning int value to wrapper", e2);
        }
    }
    ...
    public final void zza(zzp zzp, byte[] bArr) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning byte array to wrapper", e2);
        }
    }
    ...
    public final void zza(zzp zzp, boolean z) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning boolean value to wrapper", e2);
        }
    }
    ...
    public final void zza(zzp zzp, ArrayList<Bundle> arrayList) {
        ...
        try {
            ...
            this.zzj.zzab().zzgn().zza("Error returning bundle list to wrapper", e2);
        }
    }
    ...
    public static ArrayList<Bundle> zzd(List<zzq> list) {
        ...
        for (zzq next : list) {
            ...
            bundle.putString(AppMeasurementSdk.ConditionalUserProperty.ORIGIN, next.origin);
    ...
    public final URL zza(long j, String str, String str2) {
        try {
            ...
            zzab().zzgk().zza("Failed to create BOW URL for Deferred Deep Link. exception", e2.getMessage());
            return null;
        }
    }
