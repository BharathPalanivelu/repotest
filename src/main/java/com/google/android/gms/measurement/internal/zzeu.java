...
public final class zzeu {
    ...
    public final void zzat(String str) {
        ...
        if (resolveInfo.serviceInfo != null) {
            ...
            try {
                ...
                this.zzj.zzab().zzgk().zza("Exception occurred while binding to Install Referrer Service", e2.getMessage());
            }
        }
    }
    ...
    private final boolean zzhn() {
        try {
            ...
            this.zzj.zzab().zzgq().zza("Failed to retrieve Play Store version", e2);
            return false;
        }
    }
    ...
    public final Bundle zza(String str, zzf zzf) {
        ...
        try {
            ...
            this.zzj.zzab().zzgk().zza("Exception occurred while retrieving the Install Referrer", e2.getMessage());
            return null;
        }
    }
}
