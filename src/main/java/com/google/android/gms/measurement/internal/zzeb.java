...
public final class zzeb extends zzg {
    ...
    public final void resetAnalyticsData() {
        ...
        try {
            ...
            zzab().zzgk().zza("Error resetting local analytics data. error", e2);
        }
    }
    ...
    public final java.util.List<com.google.android.gms.common.internal.safeparcel.AbstractSafeParcelable> zzc(int r25) {
        ...
        L_0x0039:
            ...
            boolean r0 = r0.zza((com.google.android.gms.measurement.internal.zzdu<java.lang.Boolean>) r10)     // Catch:{ SQLiteFullException -> 0x01e2, SQLiteDatabaseLockedException -> 0x01de, SQLiteException -> 0x01db, all -> 0x01d8 }
