...
public final class zzjn extends AbstractSafeParcelable {
    ...
    zzjn(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) long j, @SafeParcelable.Param(id = 4) Long l, @SafeParcelable.Param(id = 5) Float f2, @SafeParcelable.Param(id = 6) String str2, @SafeParcelable.Param(id = 7) String str3, @SafeParcelable.Param(id = 8) Double d2) {
        this.versionCode = i;
        this.name = str;
        this.zztr = j;
        this.zzts = l;
        ...
        this.zztt = null;
        if (i == 1) {
            this.zztu = f2 != null ? Double.valueOf(f2.doubleValue()) : d3;
        } else {
            this.zztu = d2;
        }
        this.zzkr = str2;
