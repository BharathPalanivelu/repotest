...
final class k {
    ...
    private final int f9233e = (this.f9232d * 2);

    /* renamed from: f  reason: collision with root package name */
    private final short[] f9234f;
    ...
    public void a(ShortBuffer shortBuffer) {
        ...
        int i3 = remaining / i2;
        b(i3);
        shortBuffer.get(this.h, this.q * this.f9230b, ((i2 * i3) * 2) / 2);
        this.q += i3;
        c();
    }

    public void b(ShortBuffer shortBuffer) {
        int min = Math.min(shortBuffer.remaining() / this.f9230b, this.r);
        shortBuffer.put(this.j, 0, this.f9230b * min);
        this.r -= min;
        short[] sArr = this.j;
        int i2 = this.f9230b;
    ...
    private void a(int i2) {
        ...
        if (i3 > i4) {
            this.i = i4 + (i4 / 2) + i2;
            this.j = Arrays.copyOf(this.j, this.i * this.f9230b);
        }
    }
    ...
    private void b(int i2) {
        ...
        int i4 = this.f9235g;
        if (i3 > i4) {
            this.f9235g = i4 + (i4 / 2) + i2;
            this.h = Arrays.copyOf(this.h, this.f9235g * this.f9230b);
        }
    }
    ...
    private int d(int i2) {
        int min = Math.min(this.f9233e, this.t);
        a(this.h, i2, min);
        this.t -= min;
        return min;
    }
    ...
    private void b(short[] sArr, int i2, int i3) {
        ...
        for (int i8 = 0; i8 < i4; i8++) {
            ...
            this.f9234f[i8] = (short) (i9 / i6);
        }
    }

    private int a(short[] sArr, int i2, int i3, int i4) {
        int i5 = i2 * this.f9230b;
        int i6 = 1;
        int i7 = 0;
        int i8 = 0;
        int i9 = 255;
    ...
    private int a(short[] sArr, int i2, boolean z) {
        ...
        if (this.f9230b == 1 && i5 == 1) {
            i3 = a(sArr, i2, this.f9231c, this.f9232d);
        } else {
            b(sArr, i2, i5);
            int a2 = a(this.f9234f, 0, this.f9231c / i5, this.f9232d / i5);
            if (i5 != 1) {
                int i6 = a2 * i5;
                int i7 = i5 * 4;
                int i8 = i6 - i7;
    ...
    private void e(int i2) {
        ...
        if (i4 > i5) {
            this.k = i5 + (i5 / 2) + i3;
            this.l = Arrays.copyOf(this.l, this.k * this.f9230b);
        }
        short[] sArr = this.j;
        int i6 = this.f9230b;
    ...
    private int a(short[] sArr, int i2, float f2, int i3) {
        ...
        a(i4);
        a(i4, this.f9230b, this.j, this.r, sArr, i2, sArr, i2 + i3);
        this.r += i4;
        return i4;
    }
    ...
    private int b(short[] sArr, int i2, float f2, int i3) {
        ...
        a(i4, this.f9230b, this.j, this.r + i3, sArr, i2 + i3, sArr, i2);
        this.r += i5;
        return i4;
    }
