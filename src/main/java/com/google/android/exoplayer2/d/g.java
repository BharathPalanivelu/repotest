...
public abstract class g<I extends e, O extends f, E extends Exception> implements c<I, O, E> {
    ...
    private final Thread f9285a;

    /* renamed from: b  reason: collision with root package name */
    private final Object f9286b = new Object();

    /* renamed from: c  reason: collision with root package name */
    private final LinkedList<I> f9287c = new LinkedList<>();

    /* renamed from: d  reason: collision with root package name */
    private final LinkedList<O> f9288d = new LinkedList<>();

    /* renamed from: e  reason: collision with root package name */
    private final I[] f9289e;

    /* renamed from: f  reason: collision with root package name */
    private final O[] f9290f;
    ...
    protected g(I[] iArr, O[] oArr) {
        this.f9289e = iArr;
        this.f9291g = iArr.length;
        for (int i2 = 0; i2 < this.f9291g; i2++) {
            this.f9289e[i2] = g();
        }
        this.f9290f = oArr;
        this.h = oArr.length;
    ...
    public final void a(int i2) {
        a.b(this.f9291g == this.f9289e.length);
        for (I e2 : this.f9289e) {
            e2.e(i2);
        }
    }
    ...
    public final void c() {
        synchronized (this.f9286b) {
            ...
            while (!this.f9287c.isEmpty()) {
                b((e) this.f9287c.removeFirst());
            }
            while (!this.f9288d.isEmpty()) {
                b((f) this.f9288d.removeFirst());
            }
        }
    }
    ...
    private boolean l() throws java.lang.InterruptedException {
        ...
        L_0x0003:
            ...
            if (r1 != 0) goto L_0x0013
            java.lang.Object r1 = r6.f9286b     // Catch:{ all -> 0x0086 }
        ...
        L_0x0013:
            ...
            return r2
        L_0x001a:
            java.util.LinkedList<I> r1 = r6.f9287c     // Catch:{ all -> 0x0086 }
            java.lang.Object r1 = r1.removeFirst()     // Catch:{ all -> 0x0086 }
            com.google.android.exoplayer2.d.e r1 = (com.google.android.exoplayer2.d.e) r1     // Catch:{ all -> 0x0086 }
            O[] r3 = r6.f9290f     // Catch:{ all -> 0x0086 }
        ...
        L_0x0059:
            ...
            goto L_0x007e
        L_0x0064:
            boolean r0 = r3.b()     // Catch:{ all -> 0x0083 }
        ...
        L_0x0073:
            int r0 = r6.m     // Catch:{ all -> 0x0083 }
            r3.f9284b = r0     // Catch:{ all -> 0x0083 }
            r6.m = r2     // Catch:{ all -> 0x0083 }
            java.util.LinkedList<O> r0 = r6.f9288d     // Catch:{ all -> 0x0083 }
        ...
        L_0x008a:
            goto L_0x0089
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.d.g.l():boolean");
    }

    private boolean m() {
        return !this.f9287c.isEmpty() && this.h > 0;
    }
