...
final class b implements e {
    ...
    private final com.google.android.exoplayer2.p.b[] f11131a;

    /* renamed from: b  reason: collision with root package name */
    private final long[] f11132b;

    public b(com.google.android.exoplayer2.p.b[] bVarArr, long[] jArr) {
        this.f11131a = bVarArr;
        this.f11132b = jArr;
    }

    public int a(long j) {
        int b2 = v.b(this.f11132b, j, false, false);
        if (b2 < this.f11132b.length) {
            return b2;
        }
        return -1;
    }
    ...
    public int b() {
        return this.f11132b.length;
    }

    public long a(int i) {
        boolean z = true;
        a.a(i >= 0);
        if (i >= this.f11132b.length) {
            z = false;
        }
        a.a(z);
    ...
    public List<com.google.android.exoplayer2.p.b> b(long j) {
        int a2 = v.a(this.f11132b, j, true, false);
        if (a2 != -1) {
            com.google.android.exoplayer2.p.b[] bVarArr = this.f11131a;
            if (bVarArr[a2] != null) {
