...
final class f {
    ...
    public static final Pattern f10599a = Pattern.compile("^(\\S+)\\s+-->\\s+(\\S+)(.*)?$");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f10600b = Pattern.compile("(\\S+?):(\\S+)");

    /* renamed from: c  reason: collision with root package name */
    private final StringBuilder f10601c = new StringBuilder();

    /* access modifiers changed from: package-private */
    public boolean a(k kVar, e.a aVar, List<d> list) {
        String y = kVar.y();
        Matcher matcher = f10599a.matcher(y);
        if (matcher.matches()) {
            return a((String) null, matcher, kVar, aVar, this.f10601c, list);
        }
        Matcher matcher2 = f10599a.matcher(kVar.y());
        if (!matcher2.matches()) {
            return false;
        }
        return a(y.trim(), matcher2, kVar, aVar, this.f10601c, list);
    }

    static void a(String str, e.a aVar) {
        Matcher matcher = f10600b.matcher(str);
        while (matcher.find()) {
    ...
    private static int a(java.lang.String r5) {
        ...
        L_0x0058:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.f.f.a(java.lang.String):int");
    }
    ...
    private static android.text.Layout.Alignment b(java.lang.String r6) {
        ...
        L_0x0074:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.f.f.b(java.lang.String):android.text.Layout$Alignment");
    }
    ...
    private static void a(java.lang.String r5, android.text.SpannableStringBuilder r6) {
        ...
        L_0x007e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.f.f.a(java.lang.String, android.text.SpannableStringBuilder):void");
    }
    ...
    private static boolean c(java.lang.String r8) {
        ...
        L_0x006e:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.f.f.c(java.lang.String):boolean");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void a(java.lang.String r8, com.google.android.exoplayer2.j.f.f.a r9, android.text.SpannableStringBuilder r10, java.util.List<com.google.android.exoplayer2.j.f.d> r11, java.util.List<com.google.android.exoplayer2.j.f.f.b> r12) {
        /*
            int r0 = r9.f10604b
            int r1 = r10.length()
            java.lang.String r2 = r9.f10603a
            int r3 = r2.hashCode()
            r4 = 0
            r5 = 2
            r6 = 1
        ...
        L_0x0092:
            r12.clear()
            a((java.util.List<com.google.android.exoplayer2.j.f.d>) r11, (java.lang.String) r8, (com.google.android.exoplayer2.j.f.f.a) r9, (java.util.List<com.google.android.exoplayer2.j.f.f.b>) r12)
            int r8 = r12.size()
        L_0x009c:
            if (r4 >= r8) goto L_0x00ac
            java.lang.Object r9 = r12.get(r4)
            com.google.android.exoplayer2.j.f.f$b r9 = (com.google.android.exoplayer2.j.f.f.b) r9
            com.google.android.exoplayer2.j.f.d r9 = r9.f10608b
            a((android.text.SpannableStringBuilder) r10, (com.google.android.exoplayer2.j.f.d) r9, (int) r0, (int) r1)
            int r4 = r4 + 1
            goto L_0x009c
        L_0x00ac:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.f.f.a(java.lang.String, com.google.android.exoplayer2.j.f.f$a, android.text.SpannableStringBuilder, java.util.List, java.util.List):void");
    }
    ...
    private static void a(List<d> list, String str, a aVar, List<b> list2) {
        ...
        for (int i = 0; i < size; i++) {
            d dVar = list.get(i);
            int a2 = dVar.a(str, aVar.f10603a, aVar.f10606d, aVar.f10605c);
            if (a2 > 0) {
    ...
    private static final class b implements Comparable<b> {
        ...
        public int compareTo(b bVar) {
            return this.f10607a - bVar.f10607a;
        }
    }
    ...
    private static final class a {
        ...
        private static final String[] f10602e = new String[0];
