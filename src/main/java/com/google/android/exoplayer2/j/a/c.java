...
public final class c extends d {
    ...
    private final k f10453a = new k();

    /* renamed from: b  reason: collision with root package name */
    private final j f10454b = new j();
    ...
    private List<com.google.android.exoplayer2.j.a> f10458f;

    /* renamed from: g  reason: collision with root package name */
    private List<com.google.android.exoplayer2.j.a> f10459g;
    private b h;
    private int i;
    ...
    public c(int i2) {
        this.f10455c = i2 == -1 ? 1 : i2;
        this.f10456d = new a[8];
        for (int i3 = 0; i3 < 8; i3++) {
            this.f10456d[i3] = new a();
        }
        this.f10457e = this.f10456d[0];
        p();
    }
    ...
    public void c() {
        ...
        this.f10459g = null;
        this.i = 0;
        this.f10457e = this.f10456d[this.i];
        p();
        this.h = null;
    }
    ...
    public boolean e() {
        return this.f10458f != this.f10459g;
    }

    /* access modifiers changed from: protected */
    public d f() {
        List<com.google.android.exoplayer2.j.a> list = this.f10458f;
        this.f10459g = list;
        return new f(list);
    }
    ...
    public void a(h hVar) {
        this.f10453a.a(hVar.f9280b.array(), hVar.f9280b.limit());
        while (this.f10453a.b() >= 3) {
            int g2 = this.f10453a.g() & 7;
            int i2 = g2 & 3;
            boolean z = false;
            boolean z2 = (g2 & 4) == 4;
            byte g3 = (byte) this.f10453a.g();
            byte g4 = (byte) this.f10453a.g();
            if ((i2 == 2 || i2 == 3) && z2) {
                if (i2 == 3) {
                    i();
                    int i3 = (g3 & 192) >> 6;
                    ...
                    if (bVar2 == null) {
                        ...
                        byte[] bArr2 = bVar2.f10469c;
                        b bVar3 = this.h;
                        int i5 = bVar3.f10470d;
                        bVar3.f10470d = i5 + 1;
                        bArr2[i5] = g3;
                        byte[] bArr3 = this.h.f10469c;
                        b bVar4 = this.h;
                        int i6 = bVar4.f10470d;
                        bVar4.f10470d = i6 + 1;
                        bArr3[i6] = g4;
                    }
                }
                if (this.h.f10470d == (this.h.f10468b * 2) - 1) {
                    i();
                }
            }
        }
    ...
    private void j() {
        if (this.h.f10470d != (this.h.f10468b * 2) - 1) {
            Log.w("Cea708Decoder", "DtvCcPacket ended prematurely; size is " + ((this.h.f10468b * 2) - 1) + ", but current index is " + this.h.f10470d + " (sequence number " + this.h.f10467a + "); ignoring packet");
            return;
        }
        this.f10454b.a(this.h.f10469c, this.h.f10470d);
        int c2 = this.f10454b.c(3);
        int c3 = this.f10454b.c(5);
        if (c2 == 7) {
            this.f10454b.b(2);
            c2 += this.f10454b.c(6);
        }
        ...
        } else if (c2 == this.f10455c) {
            boolean z = false;
            while (this.f10454b.a() > 0) {
                int c4 = this.f10454b.c(8);
                if (c4 == 16) {
                    int c5 = this.f10454b.c(8);
                    if (c5 <= 31) {
                        c(c5);
                    } else if (c5 <= 127) {
                        g(c5);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x009b, code lost:
        if (r4.f10454b.d() == false) goto L_0x00a6;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x00fb, code lost:
        if (r4.f10454b.d() == false) goto L_0x0106;
     */
    ...
    private void b(int r5) {
        ...
        L_0x0020:
            ...
            r4.i = r5
            com.google.android.exoplayer2.j.a.c$a[] r0 = r4.f10456d
            r5 = r0[r5]
            r4.f10457e = r5
            goto L_0x0117
        L_0x0033:
            com.google.android.exoplayer2.j.a.c$a r5 = r4.f10457e
            boolean r5 = r5.d()
            if (r5 != 0) goto L_0x0044
            com.google.android.exoplayer2.n.j r5 = r4.f10454b
            r0 = 32
            r5.b(r0)
            goto L_0x0117
        L_0x0044:
        ...
        L_0x0093:
            ...
            com.google.android.exoplayer2.j.a.c$a[] r5 = r4.f10456d
            int r0 = 8 - r2
            r5 = r5[r0]
            r5.b()
        L_0x00a6:
        ...
        L_0x00aa:
            ...
            com.google.android.exoplayer2.n.j r0 = r4.f10454b
            boolean r0 = r0.d()
        ...
        L_0x0117:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.a.c.b(int):void");
    }
    ...
    private void d(int i2) {
        if (i2 <= 135) {
            ...
            this.f10454b.b(2);
            this.f10454b.b(this.f10454b.c(6) * 8);
        }
    }
    ...
    private void k() {
        this.f10457e.a(this.f10454b.c(4), this.f10454b.c(2), this.f10454b.c(2), this.f10454b.d(), this.f10454b.d(), this.f10454b.c(3), this.f10454b.c(3));
    }

    private void l() {
        int a2 = a.a(this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2));
        int a3 = a.a(this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2));
        this.f10454b.b(2);
        this.f10457e.a(a2, a3, a.b(this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2)));
    }

    private void m() {
        this.f10454b.b(4);
        int c2 = this.f10454b.c(4);
        this.f10454b.b(2);
        this.f10457e.a(c2, this.f10454b.c(6));
    }

    private void n() {
        int a2 = a.a(this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2));
        int c2 = this.f10454b.c(2);
        int b2 = a.b(this.f10454b.c(2), this.f10454b.c(2), this.f10454b.c(2));
        if (this.f10454b.d()) {
            c2 |= 4;
        }
        boolean d2 = this.f10454b.d();
        int c3 = this.f10454b.c(2);
        int c4 = this.f10454b.c(2);
        int c5 = this.f10454b.c(2);
        this.f10454b.b(8);
        this.f10457e.a(a2, b2, d2, c2, c3, c4, c5);
    }

    private void i(int i2) {
        a aVar = this.f10456d[i2];
        this.f10454b.b(2);
        boolean d2 = this.f10454b.d();
        boolean d3 = this.f10454b.d();
        boolean d4 = this.f10454b.d();
        int c2 = this.f10454b.c(3);
        boolean d5 = this.f10454b.d();
        int c3 = this.f10454b.c(7);
        int c4 = this.f10454b.c(8);
        int c5 = this.f10454b.c(4);
        int c6 = this.f10454b.c(4);
        this.f10454b.b(2);
        int c7 = this.f10454b.c(6);
        this.f10454b.b(2);
        aVar.a(d2, d3, d4, c2, d5, c3, c4, c6, c7, c5, this.f10454b.c(3), this.f10454b.c(3));
    }

    private List<com.google.android.exoplayer2.j.a> o() {
        ArrayList arrayList = new ArrayList();
        for (int i2 = 0; i2 < 8; i2++) {
            if (!this.f10456d[i2].a() && this.f10456d[i2].e()) {
                arrayList.add(this.f10456d[i2].h());
            }
        }
    ...
    private static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final int f10460a = a(2, 2, 2, 0);

        /* renamed from: b  reason: collision with root package name */
        public static final int f10461b = a(0, 0, 0, 0);

        /* renamed from: c  reason: collision with root package name */
        public static final int f10462c = a(0, 0, 0, 3);

        /* renamed from: d  reason: collision with root package name */
        private static final int[] f10463d = {0, 0, 0, 0, 0, 2, 0};

        /* renamed from: e  reason: collision with root package name */
        private static final int[] f10464e = {0, 0, 0, 0, 0, 0, 2};

        /* renamed from: f  reason: collision with root package name */
        private static final int[] f10465f = {3, 3, 3, 3, 3, 3, 1};

        /* renamed from: g  reason: collision with root package name */
        private static final boolean[] f10466g = {false, false, false, true, true, true, false};
        ...
        public void a(boolean z2, boolean z3, boolean z4, int i2, boolean z5, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
            ...
            if (!(i10 == 0 || this.x == i10)) {
                this.x = i10;
                int i13 = i10 - 1;
                a(h[i13], f10462c, f10466g[i13], 0, f10464e[i13], f10465f[i13], f10463d[i13]);
            }
            if (i11 != 0 && this.y != i11) {
                this.y = i11;
                int i14 = i11 - 1;
                a(0, 1, 1, false, false, j[i14], i[i14]);
                a(f10460a, k[i14], f10461b);
            }
        }
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public com.google.android.exoplayer2.j.a.b h() {
            /*
                r15 = this;
                boolean r0 = r15.a()
            ...
            L_0x00a7:
                ...
                r0 = 1
            L_0x00ae:
                com.google.android.exoplayer2.j.a.b r13 = new com.google.android.exoplayer2.j.a.b
                r5 = 0
                r11 = 1
                int r12 = r15.z
                int r14 = r15.p
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.a.c.a.h():com.google.android.exoplayer2.j.a.b");
        }
        ...
        public static int a(int r4, int r5, int r6, int r7) {
            /*
                r0 = 4
                r1 = 0
                com.google.android.exoplayer2.n.a.a(r4, r1, r0)
                com.google.android.exoplayer2.n.a.a(r5, r1, r0)
                com.google.android.exoplayer2.n.a.a(r6, r1, r0)
                com.google.android.exoplayer2.n.a.a(r7, r1, r0)
                r0 = 1
            ...
            L_0x0032:
                ...
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.j.a.c.a.a(int, int, int, int):int");
        }
    }
}
