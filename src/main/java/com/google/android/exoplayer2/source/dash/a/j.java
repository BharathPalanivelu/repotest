...
public final class j {
    ...
    public String a(String str, int i, int i2, long j) {
        ...
        while (true) {
            int i4 = this.f11893d;
            if (i3 < i4) {
                sb.append(this.f11890a[i3]);
                int[] iArr = this.f11891b;
                if (iArr[i3] == 1) {
                    sb.append(str);
                } else if (iArr[i3] == 2) {
                    sb.append(String.format(Locale.US, this.f11892c[i3], new Object[]{Integer.valueOf(i)}));
                } else if (iArr[i3] == 3) {
                    sb.append(String.format(Locale.US, this.f11892c[i3], new Object[]{Integer.valueOf(i2)}));
                } else if (iArr[i3] == 4) {
                    sb.append(String.format(Locale.US, this.f11892c[i3], new Object[]{Long.valueOf(j)}));
                }
                i3++;
            } else {
                sb.append(this.f11890a[i4]);
                return sb.toString();
            }
        }
    }
