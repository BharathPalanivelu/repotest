...
public class ChatWindowButtonSelectionRequest implements LiveAgentSessionRequest {
    ...
    public ChatWindowButtonSelectionRequest(int i, String str, String str2) {
        this.mButtonSelectionActions = new ButtonSelectionAction[]{new ButtonSelectionAction(i)};
