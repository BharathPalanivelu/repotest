...
public final class u {
    ...
    public static synchronized String m186(WeakReference<Context> weakReference) {
        ...
        synchronized (u.class) {
            ...
            if (f243 == null) {
                String str3 = null;
                if (weakReference.get() != null) {
                    str3 = AppsFlyerLibCore.m46(weakReference.get()).getString("AF_INSTALLATION", (String) null);
                }
                if (str3 != null) {
                    f243 = str3;
                } else {
                    try {
                        ...
                        String str4 = f243;
                        SharedPreferences.Editor edit = AppsFlyerLibCore.m46(weakReference.get()).edit();
                ...
                if (f243 != null) {
                    AppsFlyerProperties.getInstance().set("uid", f243);
                }
            }
            String str5 = f243;
            return str5;
    ...
    private static java.lang.String m185(java.io.File r6) {
        /*
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.u.m185(java.io.File):java.lang.String");
    }
}
