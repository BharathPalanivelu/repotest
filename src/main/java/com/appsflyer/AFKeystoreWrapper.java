...
class AFKeystoreWrapper {
    ...
    public AFKeystoreWrapper(Context context) {
        ...
        try {
            this.f20 = KeyStore.getInstance("AndroidKeyStore");
            this.f20.load((KeyStore.LoadStoreParameter) null);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005b, code lost:
        r7.f22 = r3[1].trim();
        r7.f23 = java.lang.Integer.parseInt(r1[1].trim());
     */
    ...
    public final boolean m32() {
        /*
            r7 = this;
            java.lang.Object r0 = r7.f24
            monitor-enter(r0)
            java.security.KeyStore r1 = r7.f20     // Catch:{ all -> 0x0091 }
            r2 = 1
            r3 = 0
            if (r1 == 0) goto L_0x008e
            java.security.KeyStore r1 = r7.f20     // Catch:{ Throwable -> 0x0072 }
        ...
        L_0x0095:
            goto L_0x0094
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.AFKeystoreWrapper.m32():boolean");
    }
    ...
    public final void m31(String str) {
        ...
        try {
            ...
            synchronized (this.f24) {
                if (!this.f20.containsAlias(str)) {
