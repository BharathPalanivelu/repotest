...
public class Body {
    protected long addr;
    private Box2dArray<Fixture> fixtures = new Box2dArray<>(2);
    protected Box2dArray<JointEdge> joints = new Box2dArray<>(2);
    ...
    public Fixture createFixture(Shape shape, float f2) {
        long jniCreateFixture = jniCreateFixture(this.addr, shape.addr, f2);
        Fixture obtain = this.world.freeFixtures.obtain();
        obtain.reset(this, jniCreateFixture);
        this.world.fixtures.put(obtain.addr, obtain);
        this.fixtures.add(obtain);
    ...
    public void destroyFixture(Fixture fixture) {
        ...
        fixture.setUserData((Object) null);
    ...
    public void setTransform(Vector2 vector2, float f2) {
        jniSetTransform(this.addr, vector2.x, vector2.y, f2);
    }
    ...
    public void applyForce(float f2, float f3, float f4, float f5, boolean z) {
        jniApplyForce(this.addr, f2, f3, f4, f5, z);
    }
    ...
    public void applyForceToCenter(float f2, float f3, boolean z) {
        jniApplyForceToCenter(this.addr, f2, f3, z);
    }

    public void applyTorque(float f2, boolean z) {
        jniApplyTorque(this.addr, f2, z);
    }
    ...
    public void applyLinearImpulse(float f2, float f3, float f4, float f5, boolean z) {
        jniApplyLinearImpulse(this.addr, f2, f3, f4, f5, z);
    }

    public void applyAngularImpulse(float f2, boolean z) {
        jniApplyAngularImpulse(this.addr, f2, z);
    }
    ...
    public Box2dArray<Fixture> getFixtureList() {
        return this.fixtures;
    }

    public Box2dArray<JointEdge> getJointList() {
        return this.joints;
    }
    ...
    public void setGravityScale(float f2) {
        jniSetGravityScale(this.addr, f2);
    }
