...
import com.badlogic.gdx.physics.box2d.utils.Box2dRuntimeException;
...
public class Fixture {
    ...
    public Shape.Type getType() {
        ...
        throw new Box2dRuntimeException("Unknown shape type!");
    }
    ...
    public Shape getShape() {
        if (this.shape == null) {
            ...
            if (jniGetShape != 0) {
                ...
                throw new Box2dRuntimeException("Null shape address!");
            }
        }
        return this.shape;
    }
    ...
    public boolean testPoint(float f2, float f3) {
        return jniTestPoint(this.addr, f2, f3);
    }

    public void setDensity(float f2) {
        jniSetDensity(this.addr, f2);
    }
    ...
    public void setRestitution(float f2) {
        jniSetRestitution(this.addr, f2);
    }
