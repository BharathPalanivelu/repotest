...
public class ChainShape extends Shape {
    ...
    private native void jniSetNextVertex(long j, float f2, float f3);

    private native void jniSetPrevVertex(long j, float f2, float f3);
    ...
    public void setPrevVertex(float f2, float f3) {
        jniSetPrevVertex(this.addr, f2, f3);
    }
    ...
    public void setNextVertex(float f2, float f3) {
        jniSetNextVertex(this.addr, f2, f3);
    }
