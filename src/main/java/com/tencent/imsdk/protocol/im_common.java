...
public final class im_common {
    ...
    public static final class User extends MessageMicro<User> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 45, 48, 58, 64, 72, 82}, new String[]{"uin", "app_id", "instance_id", "app_type", "client_ip", ServerProtocol.FALLBACK_DIALOG_PARAM_VERSION, "str_phone_number", "platform_id", IjkMediaMeta.IJKM_KEY_LANGUAGE, "equip_key"}, new Object[]{0L, 0, 0, 0, 0, 0, "", 0, 0, ByteStringMicro.EMPTY}, User.class);
        public final PBUInt32Field app_id = PBField.initUInt32(0);
