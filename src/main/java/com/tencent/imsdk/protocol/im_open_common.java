...
public final class im_open_common {
    ...
    public static final class UserId extends MessageMicro<UserId> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{Scopes.OPEN_ID, "uin", "uin_type"}, new Object[]{ByteStringMicro.EMPTY, 0L, 0}, UserId.class);
        public final PBBytesField openid = PBField.initBytes(ByteStringMicro.EMPTY);
        public final PBUInt64Field uin = PBField.initUInt64(0);
    ...
    public static final class UserStatus extends MessageMicro<UserStatus> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{Scopes.OPEN_ID, "status", "network_type"}, new Object[]{ByteStringMicro.EMPTY, 0, 0}, UserStatus.class);
