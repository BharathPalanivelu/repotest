...
public class BaseConstants {
    ...
    public static final int IMCORE_REVISION = 13740;
    public static final String IMCORE_VERSION = "3.3.2";
    public static final String IMSDK_NAME = "imsdk";
    public static final int IMSDK_REVISION = 13759;
