...
public final class mobroute {
    ...
    public static final class MobRouteSSOListInfo extends MessageMicro<MobRouteSSOListInfo> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{"string_ip", "uint32_port", "uint32_type"}, new Object[]{"", 0, 0}, MobRouteSSOListInfo.class);
