...
public final class stat_forceoffline {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 40, 48}, new String[]{"uint32_seqno", "uint32_kick_type", "str_info", "str_title", "uint32_same_device", "uint32_clear_sig"}, new Object[]{0, 0, "", "", 0, 0}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        public static final int UINT32_SEQNO_FIELD_NUMBER = 1;
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"uint32_seqno", "uint32_result"}, new Object[]{0, 0}, RspBody.class);
