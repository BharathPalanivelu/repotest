...
public final class http {
    ...
    public static final class Pair extends MessageMicro<Pair> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"key", AppMeasurementSdk.ConditionalUserProperty.VALUE}, new Object[]{"", ""}, Pair.class);
    ...
    public static final class PairBytes extends MessageMicro<PairBytes> {
        public static final int KEY_FIELD_NUMBER = 1;
        public static final int VALUE_FIELD_NUMBER = 2;
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"key", AppMeasurementSdk.ConditionalUserProperty.VALUE}, new Object[]{ByteStringMicro.EMPTY, ByteStringMicro.EMPTY}, PairBytes.class);
    ...
    public static final class Request extends MessageMicro<Request> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 90, 98, 106, 162, 170, 178, 186, 194, 250, 258, 266, TiffUtil.TIFF_TAG_ORIENTATION, 282, 290, 298, 362, 370, 378, 386}, new String[]{ShareConstants.MEDIA_URI, "method", "content_type", "accept", "accept_language", "accept_charset", "user_agent", "cookie", "referer", AppMeasurementSdk.ConditionalUserProperty.ORIGIN, "x_requested_with", "if_modified_since", "if_unmodified_since", "if_none_match", "if_match", "cache_control", "pragma", "if_range", "other_headers", "x_www_form", "body", "private_requst"}, new Object[]{"", 1, "", "*/*", "", "", "", "", "", "", "", "", "", "", "", "", "", "", null, null, ByteStringMicro.EMPTY, null}, Request.class);
    ...
    public static final class RequestPrivate extends MessageMicro<RequestPrivate> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"chunk_start", "chunk_end"}, new Object[]{-1L, -1L}, RequestPrivate.class);
    ...
    public static final class Response extends MessageMicro<Response> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 82, 90, 98, 106, 114, 168, 178, 186, 194, 202, 210, 250, 330, 338, 346}, new String[]{"status_code", "content_type", PlaceFields.LOCATION, "date", "server", "via", "x_cache", "x_cache_lookup", "age", "last_modified", "etag", "cache_control", "expires", "pragma", "set_cookie", "other_headers", "body", "private_response"}, new Object[]{200, "", "", "", "", "", "", "", 0, "", "", "", "", "", "", null, ByteStringMicro.EMPTY, null}, Response.class);
    ...
    public static final class ResponsePrivate extends MessageMicro<ResponsePrivate> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 42, 48, 56, 64, 72}, new String[]{"cache_max_age", "cache_max_stale_age", "body_encoding", "content_type", "content_charset", "request_chunk", "total_length", "raw_total_length", "chunk_start"}, new Object[]{-1L, -1L, 1, "", "utf-8", 2, -1L, -1L, -1L}, ResponsePrivate.class);
