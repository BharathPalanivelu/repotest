...
public final class logParams {
    ...
    public static final class LogParams extends MessageMicro<LogParams> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 40, 48, 56}, new String[]{"url", "authorization", "apn", "begtime", "endtime", "logtype", "seq"}, new Object[]{"", "", 1, 0, 0, 3, 0}, LogParams.class);
