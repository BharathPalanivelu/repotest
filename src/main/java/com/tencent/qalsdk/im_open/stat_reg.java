...
public final class stat_reg {
    ...
    public static final class ReqBody extends MessageMicro<ReqBody> {
        ...
        public static final int STR_DEFINE_VERSION_FIELD_NUMBER = 23;
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 58, 64, 72, 82, 90, 98, 106, 114, 122, 128, 138, IjkMediaMeta.FF_PROFILE_H264_HIGH_444, 152, 160, 168, 176, 186}, new String[]{"uint64_bid", "uint32_conn_type", "uint32_status", "uint32_kick_pc", "uint32_timestamp", "uint32_regtype", "bytes_guid", "uint32_localeid", "uint32_silent_push", "str_dev_name", "str_dev_type", "str_os_ver", "str_build_ver", "str_firmware_ver", "bytes_vendor_data", "uint64_bind_qq", "bytes_bind_qq_key", "vender_appid", "uint32_open_push", "uint64_tinyid", "uint32_product_ver", "uint32_inst_type", "str_define_version"}, new Object[]{1L, 0, 11, 0, 0, 0, ByteStringMicro.EMPTY, Integer.valueOf(I18nMsg.ZH_CN), 0, "", "", "", "", "", ByteStringMicro.EMPTY, 0L, ByteStringMicro.EMPTY, 0, 1, 0L, 0, 0, ""}, ReqBody.class);
    ...
    public static final class RspBody extends MessageMicro<RspBody> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 40, 50, 56, 64}, new String[]{"enum_cmd_error_code", "str_errmsg", "uint32_server_time", "uint32_update_flag", "uint32_timestamp", "str_client_ip", "uint32_client_port", "uint32_hello_interval"}, new Object[]{null, "", 0, 0, 0, "", 0, 300}, RspBody.class);
