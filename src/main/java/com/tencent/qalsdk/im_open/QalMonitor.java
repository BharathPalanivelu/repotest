...
public final class QalMonitor {
    ...
    public static final class Request extends MessageMicro<Request> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32}, new String[]{"seqno", "conn", "http", "drop"}, new Object[]{0, null, null, 0}, Request.class);
        ...
        public static final class Conn extends MessageMicro<Conn> {
            ...
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 50, 56, 66, 74, 82, 90, 96, 104, 114, 122}, new String[]{"timestamp", "cost_time", AbTestingModule.KEY_RESULT, "os", "os_version", "sdk_version", "process_status", "apn", "ssid", "server_ip_port", "gateway_ip", "radio_access", "errcode", "errmsg", "env"}, new Object[]{0, 0, 1, 1, "", "", 1, "", "", "", "", 0, 0, "", null}, Conn.class);
        ...
        public static final class Environment extends MessageMicro<Environment> {
            ...
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 40, 48, 56}, new String[]{"apn", "wifi_supplicant_state", "wifi_ssid", "wifi_bssid", "wifi_rssi", "rat", "rat_ss"}, new Object[]{"", "", "", "", 0, 0, 0}, Environment.class);
            public final PBStringField apn = PBField.initString("");
        ...
        public static final class Http extends MessageMicro<Http> {
            ...
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32, 40, 48, 58, 64, 74, 82, 90}, new String[]{"timestamp", ShareConstants.MEDIA_URI, "cache_cost", "total_cost", "code", "hit_cache", "apn", "radio_access", "server_ip", "gateway_ip", "errmsg"}, new Object[]{0, "", 0, 0, 0, false, "", 0, "", "", ""}, Http.class);
            public final PBStringField apn = PBField.initString("");
    ...
    public static final class Response extends MessageMicro<Response> {
        public static final int SEQNO_FIELD_NUMBER = 1;
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"seqno"}, new Object[]{0}, Response.class);
        public final PBUInt32Field seqno = PBField.initUInt32(0);
    }
