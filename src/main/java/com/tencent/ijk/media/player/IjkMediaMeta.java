...
public class IjkMediaMeta {
    ...
    public String getDurationInline() {
        long j = (this.mDurationUS + 5000) / JobManager.NS_PER_MS;
        long j2 = j / 60;
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        while (it2.hasNext()) {
            ...
            if (next2 != null) {
                ...
                ijkBitrateItem.index = Integer.parseInt(next2.getString(IJKM_KEY_BITRATE_INDEX, AppEventsConstants.EVENT_PARAM_VALUE_NO));
                ijkBitrateItem.width = Integer.parseInt(next2.getString("width", AppEventsConstants.EVENT_PARAM_VALUE_NO));
                ijkBitrateItem.height = Integer.parseInt(next2.getString("height", AppEventsConstants.EVENT_PARAM_VALUE_NO));
                ijkBitrateItem.bitrate = Integer.parseInt(next2.getString(IJKM_KEY_BITRATE, AppEventsConstants.EVENT_PARAM_VALUE_NO));
    ...
    public static class IjkStreamMeta {
        ...
        public String getFpsInline() {
            ...
            int i2 = this.mFpsDen;
            return i2 <= 0 ? "N/A" : String.valueOf(((float) i) / ((float) i2));
        }
