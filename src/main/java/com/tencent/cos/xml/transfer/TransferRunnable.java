...
public class TransferRunnable implements Runnable {
    ...
    private CosXmlProgressListener progressListener = new CosXmlProgressListener() {
        public void onProgress(long j, long j2) {
            TransferRunnable.this.notifyTransferProgress(j, j2);
        }
    };
    ...
    TransferRunnable(UploadService uploadService2, String str, TransferStatusManager transferStatusManager2) {
    ...
    public void cancel() {
        this.uploadService.abort(new CosXmlResultListener() {
            public void onSuccess(CosXmlRequest cosXmlRequest, CosXmlResult cosXmlResult) {
                QCloudLogger.i("TransferUtility", "cancel task(" + TransferRunnable.this.id + ") success", new Object[0]);
            }

            public void onFail(CosXmlRequest cosXmlRequest, CosXmlClientException cosXmlClientException, CosXmlServiceException cosXmlServiceException) {
                QCloudLogger.w("TransferUtility", "cancel task(" + TransferRunnable.this.id + ") failed", new Object[0]);
            }
        });
    }
