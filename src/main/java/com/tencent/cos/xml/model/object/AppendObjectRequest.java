...
public final class AppendObjectRequest extends ObjectRequest {
    ...
    public AppendObjectRequest(String str, String str2, InputStream inputStream2, long j) throws CosXmlClientException {
        this(str, str2);
    ...
    public Map<String, String> getQueryString() {
        this.queryParameters.put("append", (Object) null);
        this.queryParameters.put(ViewProps.POSITION, String.valueOf(this.position));
