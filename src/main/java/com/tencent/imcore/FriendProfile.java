...
public class FriendProfile {
    ...
    public BytesMap getCustom_info() {
        ...
        return new BytesMap(FriendProfile_custom_info_get, false);
    }
    ...
    public BytesCompatUintMap getCustom_info_uint() {
        ...
        return new BytesCompatUintMap(FriendProfile_custom_info_uint_get, false);
    }
    ...
    public BytesVec getSGroupNames() {
        ...
        return new BytesVec(FriendProfile_sGroupNames_get, false);
    }
    ...
    public long getULevel() {
        return internalJNI.FriendProfile_uLevel_get(this.swigCPtr, this);
    }

    public long getURole() {
        return internalJNI.FriendProfile_uRole_get(this.swigCPtr, this);
    }
