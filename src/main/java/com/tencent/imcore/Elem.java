...
public class Elem {
    ...
    public CustomElem getCustom() {
        ...
        return new CustomElem(Elem_custom_get, false);
    }
    ...
    public FaceElem getFace() {
        ...
        return new FaceElem(Elem_face_get, false);
    }
    ...
    public FileElem getFile() {
        ...
        return new FileElem(Elem_file_get, false);
    }
    ...
    public FriendChangeElem getFriend_change() {
        ...
        return new FriendChangeElem(Elem_friend_change_get, false);
    }
    ...
    public GroupReportElem getGroup_report() {
        ...
        return new GroupReportElem(Elem_group_report_get, false);
    }
    ...
    public GroupTipsElem getGroup_tips() {
        ...
        return new GroupTipsElem(Elem_group_tips_get, false);
    }
    ...
    public ImageElem getImage() {
        ...
        return new ImageElem(Elem_image_get, false);
    }
    ...
    public LocationElem getLocation() {
        ...
        return new LocationElem(Elem_location_get, false);
    }
    ...
    public ProfileChangeElem getProfile_change() {
        ...
        return new ProfileChangeElem(Elem_profile_change_get, false);
    }
    ...
    public SoundElem getSound() {
        ...
        return new SoundElem(Elem_sound_get, false);
    }
    ...
    public TextElem getText() {
        ...
        return new TextElem(Elem_text_get, false);
    }
    ...
    public UGCElem getUgc() {
        long Elem_ugc_get = internalJNI.Elem_ugc_get(this.swigCPtr, this);
        if (Elem_ugc_get == 0) {
            return null;
        }
        return new UGCElem(Elem_ugc_get, false);
    }
    ...
    public VideoElem getVideo() {
        ...
        return new VideoElem(Elem_video_get, false);
    }
    ...
    public void setUgc(UGCElem uGCElem) {
        internalJNI.Elem_ugc_set(this.swigCPtr, this, UGCElem.getCPtr(uGCElem), uGCElem);
    }
