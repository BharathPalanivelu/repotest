...
public class OfflinePushInfo {
    ...
    public AndroidOfflinePushInfo getAndroidInfo() {
        ...
        if (OfflinePushInfo_androidInfo_get == 0) {
            return null;
        }
        return new AndroidOfflinePushInfo(OfflinePushInfo_androidInfo_get, false);
    }

    public APNsInfo getApns() {
        long OfflinePushInfo_apns_get = internalJNI.OfflinePushInfo_apns_get(this.swigCPtr, this);
        if (OfflinePushInfo_apns_get == 0) {
            return null;
        }
        return new APNsInfo(OfflinePushInfo_apns_get, false);
    }
