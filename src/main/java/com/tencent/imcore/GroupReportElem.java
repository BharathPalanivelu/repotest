...
public class GroupReportElem {
    ...
    public GroupTipsMemberInfo getOperator_group_member_info() {
        ...
        return new GroupTipsMemberInfo(GroupReportElem_operator_group_member_info_get, false);
    }
    ...
    public FriendProfile getOperator_user_info() {
        ...
        return new FriendProfile(GroupReportElem_operator_user_info_get, false);
    }
    ...
    public void setOperator_group_member_info(GroupTipsMemberInfo groupTipsMemberInfo) {
        internalJNI.GroupReportElem_operator_group_member_info_set(this.swigCPtr, this, GroupTipsMemberInfo.getCPtr(groupTipsMemberInfo), groupTipsMemberInfo);
    }
