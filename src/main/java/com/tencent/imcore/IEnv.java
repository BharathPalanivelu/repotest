...
public class IEnv {
    ...
    public boolean createThread(ThreadEntry threadEntry) {
        if (getClass() == IEnv.class) {
            return internalJNI.IEnv_createThread(this.swigCPtr, this, ThreadEntry.getCPtr(threadEntry), threadEntry);
        }
        return internalJNI.IEnv_createThreadSwigExplicitIEnv(this.swigCPtr, this, ThreadEntry.getCPtr(threadEntry), threadEntry);
    }
    ...
    public boolean runOnMainThread(RunClosure runClosure) {
        if (getClass() == IEnv.class) {
            return internalJNI.IEnv_runOnMainThread(this.swigCPtr, this, RunClosure.getCPtr(runClosure), runClosure);
        }
        return internalJNI.IEnv_runOnMainThreadSwigExplicitIEnv(this.swigCPtr, this, RunClosure.getCPtr(runClosure), runClosure);
    }
