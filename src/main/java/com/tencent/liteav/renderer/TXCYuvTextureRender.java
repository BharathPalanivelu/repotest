...
public class TXCYuvTextureRender {
    ...
    float[] bt601_fullrage_ffmpeg_matrix = {1.0f, 1.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, -0.3441f, 1.772f, 1.402f, -0.7141f, BitmapDescriptorFactory.HUE_RED};
    float[] bt601_fullrange_ffmpeg_offset = {BitmapDescriptorFactory.HUE_RED, -0.5019608f, -0.5019608f};
    float[] bt601_videorage_ffmpeg_matrix = {1.1644f, 1.1644f, 1.1644f, BitmapDescriptorFactory.HUE_RED, -0.3918f, 2.0172f, 1.596f, -0.813f, BitmapDescriptorFactory.HUE_RED};
    ...
    private float[] mTextureCoordinates = {BitmapDescriptorFactory.HUE_RED, 1.0f, 1.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, BitmapDescriptorFactory.HUE_RED, 1.0f, BitmapDescriptorFactory.HUE_RED};
    ...
    private int mWidth;
    private float[] mbt601_fullRange_matrix3 = {1.0f, 1.0f, 1.0f, BitmapDescriptorFactory.HUE_RED, -0.343f, 1.765f, 1.4f, -0.711f, BitmapDescriptorFactory.HUE_RED};
    private float[] mbt601_offset_matrix = {BitmapDescriptorFactory.HUE_RED, -0.5f, -0.5f};
    private float[] mbt601_videoRange_matrix3 = {1.164f, 1.164f, 1.164f, BitmapDescriptorFactory.HUE_RED, -0.392f, 2.017f, 1.596f, -0.813f, BitmapDescriptorFactory.HUE_RED};
    private float[] mbt709_videoRange_matrix3 = {1.164f, 1.164f, 1.164f, BitmapDescriptorFactory.HUE_RED, -0.213f, 2.112f, 1.793f, -0.533f, BitmapDescriptorFactory.HUE_RED};
    ...
    public void createTexture() {
        ...
        checkError();
        this.mPositionHandle = GLES20.glGetAttribLocation(this.mProgram, ViewProps.POSITION);
        checkError();
        ...
        checkError();
        this.mConvertOffsetUniform = GLES20.glGetUniformLocation(this.mProgram, IjkMediaPlayer.OnNativeInvokeListener.ARG_OFFSET);
    ...
    private void reloadFrameBuffer() {
        if (this.mNeedReLoadFrameBuffer) {
            String str = TAG;
            TXCLog.d(str, "reloadFrameBuffer. size = " + this.mWidth + "*" + this.mHeight);
            destroyFrameBuffer();
            int[] iArr = new int[1];
            int[] iArr2 = new int[1];
