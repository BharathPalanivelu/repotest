...
public class d extends g {
    ...
    public boolean b() {
        ...
        this.s = GLES20.glGetUniformLocation(this.f31313a, "texelWidthOffset");
        this.t = GLES20.glGetUniformLocation(this.f31313a, "texelHeightOffset");
        return true;
    }
    ...
    public void a(float f2) {
        this.r = f2;
        a(this.s, this.r / ((float) this.f31317e));
        a(this.t, this.r / ((float) this.f31318f));
    }
}
