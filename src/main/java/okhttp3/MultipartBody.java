...
public final class MultipartBody extends RequestBody {
    ...
    private static final byte[] CRLF = {g.SIMPLE_LIST, 10};
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v1, resolved type: e.d} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: e.c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: e.c} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v3, resolved type: e.d} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: e.c} */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private long writeOrCountBytes(e.d r13, boolean r14) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L_0x00c5:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.MultipartBody.writeOrCountBytes(e.d, boolean):long");
    }
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                return create(new Headers.Builder().addUnsafeNonAscii(COSRequestHeaderKey.CONTENT_DISPOSITION, sb.toString()).build(), requestBody);
            }
