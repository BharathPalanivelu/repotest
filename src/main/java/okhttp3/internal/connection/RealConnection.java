...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i, int i2, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = n.a(n.b(this.rawSocket));
                this.sink = n.a(n.a(this.rawSocket));
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x00f9:
            ...
            e.v r8 = e.n.b((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            e.e r8 = e.n.a((e.v) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            r7.source = r8     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            e.u r8 = e.n.a((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
            e.d r8 = e.n.a((e.u) r8)     // Catch:{ AssertionError -> 0x012c, all -> 0x012a }
        ...
        while (true) {
            ...
            if (code != 200) {
                if (code == 407) {
                    ...
                    } else if ("close".equalsIgnoreCase(build.header(HttpConstants.Header.CONNECTION))) {
                        return authenticate;
                    } else {
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", (RequestBody) null).header(HttpConstants.Header.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(HttpConstants.Header.USER_AGENT, Version.userAgent()).build();
