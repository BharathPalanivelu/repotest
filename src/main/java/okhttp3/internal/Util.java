...
public final class Util {
    ...
    public static boolean skipAll(v vVar, int i, TimeUnit timeUnit) throws IOException {
        ...
        try {
            c cVar = new c();
            while (vVar.read(cVar, IjkMediaMeta.AV_CH_TOP_FRONT_CENTER) != -1) {
                cVar.w();
            }
    ...
    private static String inet6AddressToAscii(byte[] bArr) {
        ...
        while (i < bArr.length) {
            if (i == i3) {
                ...
                cVar.n((long) (((bArr[i] & 255) << 8) | (bArr[i + 1] & 255)));
                i += 2;
            }
        }
        return cVar.s();
    ...
    public static Headers toHeaders(List<Header> list) {
        ...
        for (Header next : list) {
            Internal.instance.addLenient(builder, next.name.a(), next.value.a());
        }
