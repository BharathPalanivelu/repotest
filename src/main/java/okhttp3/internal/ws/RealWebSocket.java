...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        final Request build2 = this.originalRequest.newBuilder().header("Upgrade", "websocket").header(HttpConstants.Header.CONNECTION, "Upgrade").header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
    ...
    public void checkResponse(Response response) throws ProtocolException {
        if (response.code() == 101) {
            String header = response.header(HttpConstants.Header.CONNECTION);
        ...
        throw new ProtocolException("Expected HTTP 101 response but was '" + response.code() + SQLBuilder.BLANK + response.message() + "'");
    }
    ...
    public synchronized void onReadPing(e.f r2) {
        /*
            r1 = this;
            monitor-enter(r1)
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<e.f> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.ws.RealWebSocket.onReadPing(e.f):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized boolean send(e.f r7, int r8) {
        /*
            r6 = this;
            monitor-enter(r6)
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.ws.RealWebSocket.send(e.f, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        ...
        r0 = e.n.a(r0.newMessageSink(((okhttp3.internal.ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.h()));
        r0.d(r1);
        r0.close();
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            java.util.ArrayDeque<e.f> r2 = r11.pongQueue     // Catch:{ all -> 0x00aa }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00aa }
            e.f r2 = (e.f) r2     // Catch:{ all -> 0x00aa }
            r3 = -1
            r4 = 0
        ...
        L_0x0056:
            ...
            e.f r1 = r1.data     // Catch:{ all -> 0x00a5 }
            ...
            int r3 = r1.h()     // Catch:{ all -> 0x00a5 }
            long r5 = (long) r3     // Catch:{ all -> 0x00a5 }
            e.u r0 = r0.newMessageSink(r2, r5)     // Catch:{ all -> 0x00a5 }
            e.d r0 = e.n.a((e.u) r0)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0086:
            ...
            e.f r3 = r5.reason     // Catch:{ all -> 0x00a5 }
    ...
    public void writePingFrame() {
        ...
        L_0x0012:
            ...
            return
        L_0x0048:
            e.f r1 = e.f.f32736b     // Catch:{ IOException -> 0x004e }
