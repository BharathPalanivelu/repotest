...
final class Relay {
    ...
    public static Relay read(File file2) throws IOException {
        ...
        if (cVar.d((long) PREFIX_CLEAN.h()).equals(PREFIX_CLEAN)) {
            ...
            long l2 = cVar.l();
            c cVar2 = new c();
            fileOperator.read(l + 32, cVar2, l2);
            return new Relay(randomAccessFile, (v) null, l, cVar2.r(), 0);
        }
    ...
    private void writeMetadata(long j) throws IOException {
        c cVar = new c();
        cVar.d(this.metadata);
        new FileOperator(this.file.getChannel()).write(32 + j, cVar, (long) this.metadata.h());
    }
    ...
    class RelaySource implements v {
        ...
        public long read(e.c r22, long r23) throws java.io.IOException {
            /*
                r21 = this;
                r1 = r21
                r2 = r23
            ...
            L_0x0020:
                ...
                e.w r0 = r1.timeout     // Catch:{ all -> 0x0137 }
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
            ...
            L_0x0039:
                okhttp3.internal.cache2.Relay r5 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                e.c r5 = r5.buffer     // Catch:{ all -> 0x0137 }
                long r5 = r5.a()     // Catch:{ all -> 0x0137 }
                long r5 = r7 - r5
            ...
            L_0x0094:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                e.c r13 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                r15 = 0
                r14 = r22
                r17 = r2
                r13.a((e.c) r14, (long) r15, (long) r17)     // Catch:{ all -> 0x0109 }
                ...
                long r16 = r7 + r11
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                e.c r0 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                e.c r18 = r0.clone()     // Catch:{ all -> 0x0109 }
                r19 = r5
                ...
                e.c r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                okhttp3.internal.cache2.Relay r8 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                e.c r8 = r8.buffer     // Catch:{ all -> 0x0106 }
                long r8 = r8.a()     // Catch:{ all -> 0x0106 }
            ...
            L_0x011b:
                ...
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                e.c r9 = r0.buffer     // Catch:{ all -> 0x0137 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r11 = r7 - r5
                r10 = r22
                r13 = r2
                r9.a((e.c) r10, (long) r11, (long) r13)     // Catch:{ all -> 0x0137 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r5 = r5 + r2
            ...
            L_0x0143:
                goto L_0x0142
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache2.Relay.RelaySource.read(e.c, long):long");
        }
