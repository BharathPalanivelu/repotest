...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = e.n.a(e.n.a());
         */
        ...
        public void run() {
            ...
            L_0x0033:
                ...
                okhttp3.internal.cache.DiskLruCache r1 = okhttp3.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                e.u r2 = e.n.a()     // Catch:{ all -> 0x0045 }
                e.d r2 = e.n.a((e.u) r2)     // Catch:{ all -> 0x0045 }
    ...
    private void readJournal() throws java.io.IOException {
        /*
            ...
            e.v r1 = r1.source(r2)
            e.e r1 = e.n.a((e.v) r1)
            java.lang.String r2 = r1.t()     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = r1.t()     // Catch:{ all -> 0x00a8 }
            java.lang.String r4 = r1.t()     // Catch:{ all -> 0x00a8 }
            java.lang.String r5 = r1.t()     // Catch:{ all -> 0x00a8 }
            java.lang.String r6 = r1.t()     // Catch:{ all -> 0x00a8 }
            ...
            r0 = 0
        L_0x0053:
            java.lang.String r2 = r1.t()     // Catch:{ EOFException -> 0x005d }
        ...
        L_0x005d:
            ...
            boolean r0 = r1.f()     // Catch:{ all -> 0x00a8 }
            if (r0 != 0) goto L_0x0070
            r9.rebuildJournal()     // Catch:{ all -> 0x00a8 }
            goto L_0x0076
        L_0x0070:
            e.d r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a8 }
    ...
    public synchronized void rebuildJournal() throws IOException {
        ...
        try {
            a2.b(MAGIC).k(10);
            a2.b("1").k(10);
            a2.o((long) this.appVersion).k(10);
            a2.o((long) this.valueCount).k(10);
            a2.k(10);
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        ...
        L_0x0022:
            ...
            e.d r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            e.d r1 = r1.b(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            e.d r1 = r1.k(r2)     // Catch:{ all -> 0x0050 }
            e.d r4 = r1.b(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
            r4.k(r1)     // Catch:{ all -> 0x0050 }
    ...
    public synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            e.d r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            e.d r7 = r7.b(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            e.d r7 = r7.k(r8)     // Catch:{ all -> 0x0074 }
            e.d r7 = r7.b(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
            r7.k(r8)     // Catch:{ all -> 0x0074 }
            e.d r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
    ...
    public synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        ...
        L_0x007f:
            ...
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = "CLEAN"
            e.d r10 = r10.b(r1)     // Catch:{ all -> 0x00fb }
            r10.k(r3)     // Catch:{ all -> 0x00fb }
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = r0.key     // Catch:{ all -> 0x00fb }
            r10.b(r1)     // Catch:{ all -> 0x00fb }
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            r0.writeLengths(r10)     // Catch:{ all -> 0x00fb }
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            r10.k(r2)     // Catch:{ all -> 0x00fb }
        ...
        L_0x00bb:
            ...
            e.d r10 = r10.b(r11)     // Catch:{ all -> 0x00fb }
            r10.k(r3)     // Catch:{ all -> 0x00fb }
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
            r10.b(r11)     // Catch:{ all -> 0x00fb }
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            r10.k(r2)     // Catch:{ all -> 0x00fb }
        L_0x00d9:
            e.d r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
    ...
    public boolean removeEntry(Entry entry) throws IOException {
        ...
        this.journalWriter.b(REMOVE).k(32).b(entry.key).k(10);
    ...
    public final class Editor {
        ...
        public e.v newSource(int r5) {
            ...
            L_0x0015:
                ...
                e.v r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
            ...
            L_0x002f:
                ...
                throw r5
            */
            throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.cache.DiskLruCache.Editor.newSource(int):e.v");
        }
