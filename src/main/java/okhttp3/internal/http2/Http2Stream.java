...
public final class Http2Stream {
    ...
    private final class FramingSource implements v {
        static final /* synthetic */ boolean $assertionsDisabled = false;
        boolean closed;
        boolean finished;
                            ...
                            if (!this.closed) {
                                if (Http2Stream.this.headersQueue.isEmpty() || Http2Stream.this.headersListener == null) {
                                    if (this.readBuffer.a() > 0) {
                                        j2 = this.readBuffer.read(cVar, Math.min(j3, this.readBuffer.a()));
    ...
    final class FramingSink implements u {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.id, true, (e.c) null, 0);
         */
