...
public final class Http2Codec implements HttpCodec {
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(response.header(HttpConstants.Header.CONTENT_TYPE), HttpHeaders.contentLength(response), n.a((v) new StreamFinishingSource(this.stream.getSource())));
    }
