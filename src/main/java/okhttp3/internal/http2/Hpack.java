    ...
    static final class Writer {
        ...
        public void writeHeaders(List<Header> list) throws IOException {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                f g2 = header.name.g();
                f fVar = header.value;
                Integer num = Hpack.NAME_TO_FIRST_INDEX.get(g2);
                if (num != null) {
                    i2 = num.intValue() + 1;
                    if (i2 > 1 && i2 < 8) {
                ...
                if (i2 == -1) {
                    ...
                    while (true) {
                        ...
                        if (Util.equal(this.dynamicTable[i5].name, g2)) {
                ...
                } else if (!g2.a(Header.PSEUDO_PREFIX) || Header.TARGET_AUTHORITY.equals(g2)) {
                    writeInt(i, 63, 64);
                    writeByteString(fVar);
                    insertIntoDynamicTable(header);
                } else {
        ...
        public void writeInt(int i, int i2, int i3) {
            ...
            int i4 = i - i2;
            while (i4 >= 128) {
                this.out.k(128 | (i4 & Hpack.PREFIX_7_BITS));
                i4 >>>= 7;
            }
            this.out.k(i4);
        }
        ...
        public void writeByteString(f fVar) throws IOException {
            ...
            f r = cVar.r();
            writeInt(r.h(), Hpack.PREFIX_7_BITS, 128);
            this.out.d(r);
        }
