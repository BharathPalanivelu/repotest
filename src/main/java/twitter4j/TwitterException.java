...
public class TwitterException extends Exception implements HttpResponseCode, TwitterResponse {
        ...
        if (str != null && str.startsWith("{")) {
            try {
                ...
                if (!jSONObject.isNull("errors")) {
                    ...
                    this.errorMessage = jSONObject2.getString(ShareConstants.WEB_DIALOG_PARAM_MESSAGE);
    ...
    public boolean exceededRateLimitation() {
        if (this.statusCode != 400 || getRateLimitStatus() == null) {
            int i = this.statusCode;
            return i == 420 || i == 429;
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        HttpResponse httpResponse = this.response;
        return httpResponse == null ? twitterException.response == null : httpResponse.equals(twitterException.response);
    }
