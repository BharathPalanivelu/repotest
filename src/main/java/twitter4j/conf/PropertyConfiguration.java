...
public final class PropertyConfiguration extends ConfigurationBase implements Serializable {
    ...
    public PropertyConfiguration(InputStream inputStream) {
        ...
        setFieldsWithTreePath(properties, Constants.URL_PATH_DELIMITER);
    }

    public PropertyConfiguration(Properties properties) {
        this(properties, Constants.URL_PATH_DELIMITER);
    }
    ...
    PropertyConfiguration(java.lang.String r6) {
        ...
        L_0x0038:
            ...
            r5.loadProperties((java.util.Properties) r0, (java.lang.String) r1)
            ...
            r5.loadProperties((java.util.Properties) r0, (java.io.InputStream) r1)
            java.lang.Class<twitter4j.conf.Configuration> r1 = twitter4j.conf.Configuration.class
            ...
            r5.loadProperties((java.util.Properties) r0, (java.io.InputStream) r1)     // Catch:{ FileNotFoundException | SecurityException -> 0x0073 }
        L_0x0073:
    ...
    PropertyConfiguration() {
        this(Constants.URL_PATH_DELIMITER);
    }
